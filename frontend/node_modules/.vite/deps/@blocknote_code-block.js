...
var RegExpSourceList = class {
  ...
  compile(onigLib) {
    if (!this._cached) {
      let regExps = this._items.map((e2) => e2.source);
      this._cached = new CompiledRule(onigLib, regExps, this._items.map((e2) => e2.ruleId));
    }
    return this._cached;
  }
  ...
  _resolveAnchors(onigLib, allowA, allowG) {
    let regExps = this._items.map((e2) => e2.resolveAnchors(allowA, allowG));
    return new CompiledRule(onigLib, regExps, this._items.map((e2) => e2.ruleId));
  }
};
...
async function normalizeGetter(p) {
  return Promise.resolve(typeof p === "function" ? p() : p).then((r2) => r2.default || r2);
}
...
function splitTokens(tokens, breakpoints) {
  ...
  return tokens.map((line) => {
    return line.flatMap((token) => {
      const breakpointsInToken = sorted.filter((i2) => token.offset < i2 && i2 < token.offset + token.content.length).map((i2) => i2 - token.offset).sort((a, b) => a - b);
...
function syncThemesTokenization(...themes) {
  ...
  for (let i2 = 0; i2 < themes[0].length; i2++) {
    const lines = themes.map((t2) => t2[i2]);
    const outLines = outThemes.map(() => []);
    outThemes.forEach((t2, i22) => t2.push(outLines[i22]));
...
function codeToTokens(internal, code, options) {
  ...
  if ("themes" in options) {
    ...
    const themes = Object.entries(options.themes).filter((i2) => i2[1]).map((i2) => ({ color: i2[0], theme: i2[1] })).sort((a, b) => a.color === defaultColor ? -1 : b.color === defaultColor ? 1 : 0);
    if (themes.length === 0)
...
var Registry2 = class extends Registry {
  ...
  loadLanguage(lang) {
    ...
    if (embeddedLazilyBy.size) {
      for (const e2 of embeddedLazilyBy) {
        this._resolvedGrammars.delete(e2.name);
        this._loadedLanguagesCache = null;
        this._syncRegistry?._injectionGrammars?.delete(e2.scopeName);
        this._syncRegistry?._grammars?.delete(e2.scopeName);
        this.loadLanguage(this._langMap.get(e2.name));
      }
    }
  }
  dispose() {
...
var Resolver = class {
  ...
  addLanguage(l) {
    ...
    if (l.injectTo) {
      l.injectTo.forEach((i2) => {
        if (!this._injections.get(i2))
          this._injections.set(i2, []);
        this._injections.get(i2).push(l.scopeName);
      });
    }
  }
...
// node_modules/@blocknote/code-block/dist/blocknote-code-block.js
var e = {
  c: () => import("./c-IXOVOWOC.js"),
  cpp: () => import("./cpp-YYBNKI7E.js"),
  "c++": () => import("./cpp-YYBNKI7E.js"),
  css: () => import("./css-UDGGFT5K.js"),
  glsl: () => import("./glsl-FLJ4BCE3.js"),
  graphql: () => import("./graphql-KPTT4KGY.js"),
  gql: () => import("./graphql-KPTT4KGY.js"),
  haml: () => import("./haml-ME35DO22.js"),
  html: () => import("./html-EHPKI3TZ.js"),
  java: () => import("./java-MYEZ43I5.js"),
  javascript: () => import("./javascript-WBBX5MDL.js"),
  js: () => import("./javascript-WBBX5MDL.js"),
  json: () => import("./json-OMTCXNIB.js"),
  jsonc: () => import("./jsonc-6NQVOVS4.js"),
  jsonl: () => import("./jsonl-AMAUA4MK.js"),
  jsx: () => import("./jsx-E7LJGUF4.js"),
  julia: () => import("./julia-TRLUCQEW.js"),
  jl: () => import("./julia-TRLUCQEW.js"),
  less: () => import("./less-RMJVLAMI.js"),
  markdown: () => import("./markdown-V6G23MNP.js"),
  md: () => import("./markdown-V6G23MNP.js"),
  mdx: () => import("./mdx-5ED2ZKUC.js"),
  php: () => import("./php-STXHVZGZ.js"),
  postcss: () => import("./postcss-3ITJXQN7.js"),
  pug: () => import("./pug-HP32JMUJ.js"),
  jade: () => import("./pug-HP32JMUJ.js"),
  python: () => import("./python-IA54MLXT.js"),
  py: () => import("./python-IA54MLXT.js"),
  r: () => import("./r-J5PUQH3D.js"),
  regexp: () => import("./regexp-GUHROZ3Q.js"),
  regex: () => import("./regexp-GUHROZ3Q.js"),
  sass: () => import("./sass-XCP3PNE2.js"),
  scss: () => import("./scss-ZDDZZG4T.js"),
  shellscript: () => import("./shellscript-QIRIDTTV.js"),
  bash: () => import("./shellscript-QIRIDTTV.js"),
  sh: () => import("./shellscript-QIRIDTTV.js"),
  shell: () => import("./shellscript-QIRIDTTV.js"),
  zsh: () => import("./shellscript-QIRIDTTV.js"),
  sql: () => import("./sql-APFDQY5T.js"),
  svelte: () => import("./svelte-FMMFW7ES.js"),
  typescript: () => import("./typescript-XSEYVIKL.js"),
  ts: () => import("./typescript-XSEYVIKL.js"),
  vue: () => import("./vue-XCI4FFSG.js"),
  "vue-html": () => import("./vue-html-EKFHQWGL.js"),
  wasm: () => import("./wasm-HZ6QHOFG.js"),
  wgsl: () => import("./wgsl-EYHIIQEQ.js"),
  xml: () => import("./xml-ZTCFHOOB.js"),
  yaml: () => import("./yaml-CBQ2CJ5P.js"),
  yml: () => import("./yaml-CBQ2CJ5P.js"),
  tsx: () => import("./tsx-HRROGT3P.js"),
  typescriptreact: () => import("./tsx-HRROGT3P.js"),
  haskell: () => import("./haskell-ZE3AUVNT.js"),
  hs: () => import("./haskell-ZE3AUVNT.js"),
  "c#": () => import("./csharp-H6RCBYRH.js"),
  csharp: () => import("./csharp-H6RCBYRH.js"),
  cs: () => import("./csharp-H6RCBYRH.js"),
  latex: () => import("./latex-XDGG4HXL.js"),
  lua: () => import("./lua-6PCTQ7UO.js"),
  mermaid: () => import("./mermaid-HQZ3BMIZ.js"),
  mmd: () => import("./mermaid-HQZ3BMIZ.js"),
  ruby: () => import("./ruby-ZZH76JCE.js"),
  rb: () => import("./ruby-ZZH76JCE.js"),
  rust: () => import("./rust-O4CP3DZY.js"),
  rs: () => import("./rust-O4CP3DZY.js"),
  scala: () => import("./scala-S2QXZ66F.js"),
  // Swift does not support pre-compilation right now
  swift: () => import("./swift-LRHVDJT3.js"),
  kotlin: () => import("./kotlin-X4DO5EOW.js"),
  kt: () => import("./kotlin-X4DO5EOW.js"),
  kts: () => import("./kotlin-X4DO5EOW.js"),
  "objective-c": () => import("./objective-c-7646AMWZ.js"),
  objc: () => import("./objective-c-7646AMWZ.js")
};
var i = {
  "github-dark": () => import("./github-dark-RGDEBPHI.js"),
  "github-light": () => import("./github-light-PVSVTML7.js")
};
var t = createdBundledHighlighter({
  langs: e,
  themes: i,
...
export {
  r as codeBlockOptions
};
//# sourceMappingURL=@blocknote_code-block.js.map
