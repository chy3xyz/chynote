...
This document records the phase 1 information architecture for public Chynote documentation. The public docs source lives in `site/`; the existing `docs/` directory remains contributor, architecture, and agent context.
