  ...
  "node_modules/fast-deep-equal/index.js"(exports, module) {
    ...
    module.exports = function equal(a3, b4) {
      ...
      if (a3 && b4 && typeof a3 == "object" && typeof b4 == "object") {
        ...
        if (Array.isArray(a3)) {
          length2 = a3.length;
          if (length2 != b4.length) return false;
          for (i = length2; i-- !== 0; )
            if (!equal(a3[i], b4[i])) return false;
          return true;
        }
        ...
        if (length2 !== Object.keys(b4).length) return false;
        for (i = length2; i-- !== 0; )
          if (!Object.prototype.hasOwnProperty.call(b4, keys2[i])) return false;
        for (i = length2; i-- !== 0; ) {
          var key = keys2[i];
...
function wordsToMd5(x2, len) {
  ...
  for (var i = 0; i < x2.length; i += 16) {
    ...
    var oldc = c;
    var oldd = d;
    a3 = md5ff(a3, b4, c, d, x2[i], 7, -680876936);
    d = md5ff(d, a3, b4, c, x2[i + 1], 12, -389564586);
    c = md5ff(c, d, a3, b4, x2[i + 2], 17, 606105819);
    b4 = md5ff(b4, c, d, a3, x2[i + 3], 22, -1044525330);
    a3 = md5ff(a3, b4, c, d, x2[i + 4], 7, -176418897);
    d = md5ff(d, a3, b4, c, x2[i + 5], 12, 1200080426);
    c = md5ff(c, d, a3, b4, x2[i + 6], 17, -1473231341);
    b4 = md5ff(b4, c, d, a3, x2[i + 7], 22, -45705983);
    a3 = md5ff(a3, b4, c, d, x2[i + 8], 7, 1770035416);
    d = md5ff(d, a3, b4, c, x2[i + 9], 12, -1958414417);
    c = md5ff(c, d, a3, b4, x2[i + 10], 17, -42063);
    b4 = md5ff(b4, c, d, a3, x2[i + 11], 22, -1990404162);
    a3 = md5ff(a3, b4, c, d, x2[i + 12], 7, 1804603682);
    d = md5ff(d, a3, b4, c, x2[i + 13], 12, -40341101);
    c = md5ff(c, d, a3, b4, x2[i + 14], 17, -1502002290);
    b4 = md5ff(b4, c, d, a3, x2[i + 15], 22, 1236535329);
    a3 = md5gg(a3, b4, c, d, x2[i + 1], 5, -165796510);
    d = md5gg(d, a3, b4, c, x2[i + 6], 9, -1069501632);
    c = md5gg(c, d, a3, b4, x2[i + 11], 14, 643717713);
    b4 = md5gg(b4, c, d, a3, x2[i], 20, -373897302);
    a3 = md5gg(a3, b4, c, d, x2[i + 5], 5, -701558691);
    d = md5gg(d, a3, b4, c, x2[i + 10], 9, 38016083);
    c = md5gg(c, d, a3, b4, x2[i + 15], 14, -660478335);
    b4 = md5gg(b4, c, d, a3, x2[i + 4], 20, -405537848);
    a3 = md5gg(a3, b4, c, d, x2[i + 9], 5, 568446438);
    d = md5gg(d, a3, b4, c, x2[i + 14], 9, -1019803690);
    c = md5gg(c, d, a3, b4, x2[i + 3], 14, -187363961);
    b4 = md5gg(b4, c, d, a3, x2[i + 8], 20, 1163531501);
    a3 = md5gg(a3, b4, c, d, x2[i + 13], 5, -1444681467);
    d = md5gg(d, a3, b4, c, x2[i + 2], 9, -51403784);
    c = md5gg(c, d, a3, b4, x2[i + 7], 14, 1735328473);
    b4 = md5gg(b4, c, d, a3, x2[i + 12], 20, -1926607734);
    a3 = md5hh(a3, b4, c, d, x2[i + 5], 4, -378558);
    d = md5hh(d, a3, b4, c, x2[i + 8], 11, -2022574463);
    c = md5hh(c, d, a3, b4, x2[i + 11], 16, 1839030562);
    b4 = md5hh(b4, c, d, a3, x2[i + 14], 23, -35309556);
    a3 = md5hh(a3, b4, c, d, x2[i + 1], 4, -1530992060);
    d = md5hh(d, a3, b4, c, x2[i + 4], 11, 1272893353);
    c = md5hh(c, d, a3, b4, x2[i + 7], 16, -155497632);
    b4 = md5hh(b4, c, d, a3, x2[i + 10], 23, -1094730640);
    a3 = md5hh(a3, b4, c, d, x2[i + 13], 4, 681279174);
    d = md5hh(d, a3, b4, c, x2[i], 11, -358537222);
    c = md5hh(c, d, a3, b4, x2[i + 3], 16, -722521979);
    b4 = md5hh(b4, c, d, a3, x2[i + 6], 23, 76029189);
    a3 = md5hh(a3, b4, c, d, x2[i + 9], 4, -640364487);
    d = md5hh(d, a3, b4, c, x2[i + 12], 11, -421815835);
    c = md5hh(c, d, a3, b4, x2[i + 15], 16, 530742520);
    b4 = md5hh(b4, c, d, a3, x2[i + 2], 23, -995338651);
    a3 = md5ii(a3, b4, c, d, x2[i], 6, -198630844);
    d = md5ii(d, a3, b4, c, x2[i + 7], 10, 1126891415);
    c = md5ii(c, d, a3, b4, x2[i + 14], 15, -1416354905);
    b4 = md5ii(b4, c, d, a3, x2[i + 5], 21, -57434055);
    a3 = md5ii(a3, b4, c, d, x2[i + 12], 6, 1700485571);
    d = md5ii(d, a3, b4, c, x2[i + 3], 10, -1894986606);
    c = md5ii(c, d, a3, b4, x2[i + 10], 15, -1051523);
    b4 = md5ii(b4, c, d, a3, x2[i + 1], 21, -2054922799);
    a3 = md5ii(a3, b4, c, d, x2[i + 8], 6, 1873313359);
    d = md5ii(d, a3, b4, c, x2[i + 15], 10, -30611744);
    c = md5ii(c, d, a3, b4, x2[i + 6], 15, -1560198380);
    b4 = md5ii(b4, c, d, a3, x2[i + 13], 21, 1309151649);
    a3 = md5ii(a3, b4, c, d, x2[i + 4], 6, -145523070);
    d = md5ii(d, a3, b4, c, x2[i + 11], 10, -1120210379);
    c = md5ii(c, d, a3, b4, x2[i + 2], 15, 718787259);
    b4 = md5ii(b4, c, d, a3, x2[i + 9], 21, -343485551);
    a3 = safeAdd(a3, olda);
    b4 = safeAdd(b4, oldb);
    c = safeAdd(c, oldc);
    d = safeAdd(d, oldd);
...
function md5cmn(q3, a3, b4, x2, s3, t) {
  return safeAdd(bitRotateLeft(safeAdd(safeAdd(a3, q3), safeAdd(x2, t)), s3), b4);
}
function md5ff(a3, b4, c, d, x2, s3, t) {
  return md5cmn(b4 & c | ~b4 & d, a3, b4, x2, s3, t);
}
function md5gg(a3, b4, c, d, x2, s3, t) {
  return md5cmn(b4 & d | c & ~d, a3, b4, x2, s3, t);
}
function md5hh(a3, b4, c, d, x2, s3, t) {
  return md5cmn(b4 ^ c ^ d, a3, b4, x2, s3, t);
}
function md5ii(a3, b4, c, d, x2, s3, t) {
  return md5cmn(c ^ (b4 | ~d), a3, b4, x2, s3, t);
}
var md5_default = md5;
...
function sha1(bytes) {
  ...
  for (var _i2 = 0; _i2 < N2; ++_i2) {
    ...
    for (var _t5 = 16; _t5 < 80; ++_t5) {
      W2[_t5] = ROTL(W2[_t5 - 3] ^ W2[_t5 - 8] ^ W2[_t5 - 14] ^ W2[_t5 - 16], 1);
    }
    var a3 = H3[0];
    var b4 = H3[1];
    var c = H3[2];
    ...
    for (var _t22 = 0; _t22 < 80; ++_t22) {
      ...
      var T3 = ROTL(a3, 5) + f(s3, b4, c, d) + e + K4[s3] + W2[_t22] >>> 0;
      e = d;
      d = c;
      c = ROTL(b4, 30) >>> 0;
      b4 = a3;
...
// node_modules/@blocknote/core/dist/blockToNode-BNoNIXU7.js
function pt(t, o = JSON.stringify) {
  const r2 = {};
  return t.filter((n) => {
    const e = o(n);
    return Object.prototype.hasOwnProperty.call(r2, e) ? false : r2[e] = true;
  });
}
function dt(t) {
  const o = t.filter(
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new Plugin({
        ...
        appendTransaction: (r2, n, e) => {
          const s3 = r2.some((g) => g.docChanged) && !n.doc.eq(e.doc), i = this.options.filterTransaction && r2.some((g) => {
            var C2, d;
            return !((d = (C2 = this.options).filterTransaction) != null && d.call(C2, g));
          });
          if (!s3 || i)
            return;
          const { tr: l } = e, { types: a3, attributeName: c, generateID: h3 } = this.options, f3 = combineTransactionSteps(
            n.doc,
            r2
          ), { mapping: p2 } = f3;
          if (getChangedRanges(f3).forEach(({ newRange: g }) => {
            const C2 = findChildrenInRange(
              e.doc,
              g,
              (y2) => a3.includes(y2.type.name)
            ), d = C2.map(({ node: y2 }) => y2.attrs[c]).filter((y2) => y2 !== null), w = dt(d);
            C2.forEach(({ node: y2, pos: m }) => {
              var z;
              const b4 = (z = l.doc.nodeAt(m)) == null ? void 0 : z.attrs[c];
              if (b4 === null) {
                const U3 = n.doc.type.createAndFill().content;
                if (n.doc.content.findDiffStart(U3) === null) {
                  const q3 = JSON.parse(
                    JSON.stringify(e.doc.toJSON())
                  );
                  if (q3.content[0].content[0].attrs.id = "initialBlockId", JSON.stringify(q3.content) === JSON.stringify(U3.toJSON())) {
              ...
              const { deleted: k } = p2.invert().mapResult(m);
              k && w.includes(b4) && l.setNodeMarkup(m, void 0, {
                ...y2.attrs,
                [c]: h3()
              });
            });
        ...
        view(r2) {
          const n = (e) => {
            let s3;
            t = !((s3 = r2.dom.parentElement) === null || s3 === void 0) && s3.contains(e.target) ? r2.dom.parentElement : null;
          };
        ...
        props: {
          ...
          handleDOMEvents: {
            ...
            drop: (r2, n) => {
              let e;
              return t !== r2.dom.parentElement || ((e = n.dataTransfer) === null || e === void 0 ? void 0 : e.effectAllowed) === "copy" ? o = true : o = false, t = null, false;
            },
          ...
          transformPasted: (r2) => {
            if (!o)
              return r2;
            const { types: n, attributeName: e } = this.options, s3 = (i) => {
              const l = [];
              return i.forEach((a3) => {
                if (a3.isText) {
                  l.push(a3);
                ...
                if (!n.includes(a3.type.name)) {
                  l.push(a3.copy(s3(a3.content)));
                  return;
                }
                const c = a3.type.create(
                  {
                    ...a3.attrs,
                    [e]: null
                  },
...
function At(t, o = true) {
  const { "data-test": r2, ...n } = t;
  if (Object.keys(n).length > 0 && o)
    throw new Error("Object must be empty " + JSON.stringify(t));
}
function Y(t, o) {
  const r2 = t.resolve(o);
  if (r2.nodeAfter && r2.nodeAfter.type.isInGroup("bnBlock"))
    return {
      posBeforeNode: r2.pos,
      node: r2.nodeAfter
    };
  let n = r2.depth, e = r2.node(n);
  for (; n > 0; ) {
    if (e.type.isInGroup("bnBlock"))
      return {
        posBeforeNode: r2.before(n),
        node: e
      };
    n--, e = r2.node(n);
  }
  const s3 = [];
  t.descendants((l, a3) => {
    l.type.isInGroup("bnBlock") && s3.push(a3);
  }), console.warn(`Position ${o} is not within a blockContainer node.`);
  const i = t.resolve(
    s3.find((l) => l >= o) || s3[s3.length - 1]
  );
  return {
    posBeforeNode: i.pos,
    node: i.nodeAfter
...
function $(t, o) {
  ...
  const r2 = t, n = o, e = n + r2.nodeSize, s3 = {
    node: r2,
    beforePos: n,
    afterPos: e
  };
  if (r2.type.name === "blockContainer") {
    let i, l;
    if (r2.forEach((a3, c) => {
      if (a3.type.spec.group === "blockContent") {
        const h3 = a3, f3 = n + c + 1, p2 = f3 + a3.nodeSize;
        i = {
          node: h3,
          beforePos: f3,
          afterPos: p2
        };
      } else if (a3.type.name === "blockGroup") {
        const h3 = a3, f3 = n + c + 1, p2 = f3 + a3.nodeSize;
        l = {
          node: h3,
          beforePos: f3,
      ...
      throw new Error(
        `blockContainer node does not contain a blockContent node in its children: ${r2}`
      );
    return {
    ...
    if (!s3.node.type.isInGroup("childContainer"))
      throw new Error(
        `bnBlock node is not in the childContainer group: ${s3.node}`
      );
    return {
      isBlockContainer: false,
      bnBlock: s3,
      childContainer: s3,
      blockNoteType: s3.node.type.name
    };
  }
}
function Z(t) {
...
function gt(t, o, r2) {
  ...
  t.content.forEach((l, a3, c) => {
    const h3 = {
      cells: []
    };
    c === 0 && l.content.forEach((f3) => {
      let p2 = f3.attrs.colwidth;
      p2 == null && (p2 = new Array(f3.attrs.colspan ?? 1).fill(void 0)), n.columnWidths.push(...p2);
    }), h3.cells = l.content.content.map((f3, p2) => (e[c] || (e[c] = []), e[c][p2] = f3.type.name === "tableHeader", {
      type: "tableCell",
      content: f3.content.content.map(
        (g) => F(g, o, r2)
      ).reduce(
        (g, C2) => {
          if (!g.length)
            return C2;
          const d = g[g.length - 1], w = C2[0];
          return w && B(d) && B(w) && JSON.stringify(d.styles) === JSON.stringify(w.styles) ? (d.text += `
` + w.text, g.push(...C2.slice(1)), g) : (g.push(...C2), g);
        },
        []
      ),
      props: {
        colspan: f3.attrs.colspan,
        rowspan: f3.attrs.rowspan,
        backgroundColor: f3.attrs.backgroundColor,
        textColor: f3.attrs.textColor,
        textAlignment: f3.attrs.textAlignment
      }
    })), n.rows.push(h3);
  });
  for (let l = 0; l < e.length; l++)
    (s3 = e[l]) != null && s3.every((a3) => a3) && (n.headerRows = (n.headerRows ?? 0) + 1);
  for (let l = 0; l < ((i = e[0]) == null ? void 0 : i.length); l++)
    e != null && e.every((a3) => a3[l]) && (n.headerCols = (n.headerCols ?? 0) + 1);
  return n;
}
function F(t, o, r2) {
  const n = [];
  let e;
  return t.content.forEach((s3) => {
    if (s3.type.name === "hardBreak") {
      if (e)
        if (B(e))
          e.text += `
`;
...
`,
    ...
    if (s3.type.name !== "link" && s3.type.name !== "text") {
      if (!o[s3.type.name]) {
        console.warn("unrecognized inline content type", s3.type.name);
        return;
      }
    ...
    const i = {};
    let l;
    for (const a3 of s3.marks)
      if (a3.type.name === "link")
        l = a3;
      else {
        const c = r2[a3.type.name];
        if (!c) {
          if (a3.type.spec.blocknoteIgnore)
            continue;
          throw new Error(`style ${a3.type.name} not found in styleSchema`);
        }
        if (c.propSchema === "boolean")
          i[c.type] = true;
        else if (c.propSchema === "string")
          i[c.type] = a3.attrs.stringValue;
        else
    ...
    }) : JSON.stringify(e.styles) === JSON.stringify(i) ? e.text += s3.textContent : (n.push(e), e = {
      type: "text",
      text: s3.textContent,
      styles: i
    }) : K(e) && (l ? e.href === l.attrs.href ? JSON.stringify(
      e.content[e.content.length - 1].styles
    ) === JSON.stringify(i) ? e.content[e.content.length - 1].text += s3.textContent : e.content.push({
      type: "text",
      text: s3.textContent,
      styles: i
    }) : (n.push(e), e = {
...
function wt(t, o, r2) {
  ...
  for (const [l, a3] of Object.entries(t.attrs)) {
    if (!e)
...
function L(t, o, r2 = _(o), n = H(o), e = N(o), s3 = j(o)) {
  var C2;
  if (!t.type.isInGroup("bnBlock"))
    throw Error("Node should be a bnBlock, but is instead: " + t.type.name);
  const i = s3 == null ? void 0 : s3.get(t);
  if (i)
    return i;
  const l = $(t, 0);
  let a3 = l.bnBlock.node.attrs.id;
  a3 === null && (a3 = Q.options.generateID());
  const c = r2[l.blockNoteType];
  if (!c)
  ...
  for (const [d, w] of Object.entries({
    ...
    const y2 = c.propSchema;
    d in y2 && !(y2[d].default === void 0 && w === void 0) && (h3[d] = w);
  }
  const f3 = r2[l.blockNoteType], p2 = [];
  (C2 = l.childContainer) == null || C2.node.forEach((d) => {
    p2.push(
      L(
        d,
        o,
  ...
  } else if (f3.content === "none")
    u = void 0;
  else
    throw new O(f3.content);
  const g = {
    id: a3,
    type: f3.type,
    props: h3,
  ...
  return s3 == null || s3.set(t, g), g;
}
function St(t, o = ht(t), r2 = _(o), n = H(o), e = N(o), s3 = j(o)) {
  const i = [];
...
function Dt(t, o, r2 = _(o), n = H(o), e = N(o), s3 = j(o)) {
  function i(l, a3, c) {
    if (l.type.name !== "blockGroup")
      throw new Error("unexpected");
    const h3 = [];
    let f3, p2;
    return l.forEach((u, g, C2) => {
      ...
      const d = C2 === 0, w = C2 === l.childCount - 1;
      if (u.firstChild.type.name === "blockGroup") {
        ...
        f3 = k.blockCutAtStart, w && (p2 = k.blockCutAtEnd), h3.push(...k.blocks);
        return;
      }
      const y2 = L(
        u,
      ...
      if (m) {
        ...
        b4 = k.blocks, w && (p2 = k.blockCutAtEnd);
      }
      w && !m && c > 1 && (p2 = y2.id), d && a3 > 1 && (f3 = y2.id), h3.push({
        ...y2,
        children: b4
      });
    }), { blocks: h3, blockCutAtStart: f3, blockCutAtEnd: p2 };
  }
...
function x(t) {
  const { height: o, width: r2 } = tt(t), n = new Array(o).fill(false).map(() => new Array(r2).fill(null)), e = (s3, i) => {
    for (let l = s3; l < o; l++)
      for (let a3 = i; a3 < r2; a3++)
        if (!n[l][a3])
          return { row: l, col: a3 };
    throw new Error(
  ...
  for (let s3 = 0; s3 < t.content.rows.length; s3++)
    for (let i = 0; i < t.content.rows[s3].cells.length; i++) {
      const l = S(t.content.rows[s3].cells[i]), a3 = D(l), c = A(l), { row: h3, col: f3 } = e(s3, i);
      for (let p2 = h3; p2 < h3 + a3; p2++)
        for (let u = f3; u < f3 + c; u++) {
          if (n[p2][u])
            throw new Error(
              `Unable to create occupancy grid for table, cell at ${p2},${u} is already occupied`
            );
          n[p2][u] = {
            row: s3,
            col: i,
...
function I(t) {
  ...
  return t.map((r2) => ({
    cells: r2.map((n) => o.has(n.row + ":" + n.col) ? false : (o.add(n.row + ":" + n.col), n.cell)).filter((n) => n !== false)
  }));
}
function E(t, o, r2 = x(o)) {
  for (let n = 0; n < r2.length; n++)
    for (let e = 0; e < r2[n].length; e++) {
      const s3 = r2[n][e];
      if (s3 && s3.row === t.row && s3.col === t.col)
        return { row: n, col: e, cell: s3.cell };
    }
  throw new Error(
...
function et(t, o, r2 = x(o)) {
  var e;
  const n = (e = r2[t.row]) == null ? void 0 : e[t.col];
  if (n)
    return {
      row: n.row,
      col: n.col,
...
function yt(t, o) {
  ...
  let n = 0;
  for (let i = 0; i < o; i++) {
    const l = (s3 = r2[n]) == null ? void 0 : s3[0];
    if (!l)
      return [];
    n += l.rowspan;
  }
  const e = new Array(r2[0].length).fill(false).map((i, l) => et(
    { row: n, col: l },
    t,
    r2
  )).filter(
  ...
  return e.filter((i, l) => e.findIndex((a3) => a3.row === i.row && a3.col === i.col) === l);
}
function Ct(t, o) {
  var s3;
  const r2 = x(t);
  if (o < 0 || o >= r2[0].length)
    return [];
  let n = 0;
  for (let i = 0; i < o; i++) {
    const l = (s3 = r2[0]) == null ? void 0 : s3[n];
    if (!l)
      return [];
    n += l.colspan;
  }
  const e = new Array(r2.length).fill(false).map((i, l) => et(
    { row: l, col: n },
    t,
    r2
  )).filter(
...
function Pt(t, o, r2, n = x(t)) {
  ...
  return n.splice(s3, 0, i), I(n);
}
function M(t) {
  return t ? v(t) ? M(t.content) : typeof t == "string" ? t.length === 0 : Array.isArray(t) ? t.every(
    (o) => typeof o == "string" ? o.length === 0 : B(o) ? o.text.length === 0 : X(o) ? typeof o.content == "string" ? o.content.length === 0 : o.content.every((r2) => r2.text.length === 0) : false
  ) : false : true;
}
function Rt(t, o, r2 = x(t)) {
  if (o === "columns") {
    let s3 = 0;
    for (let i = r2[0].length - 1; i >= 0 && r2.every(
      (a3) => M(a3[i].cell) && a3[i].colspan === 1
    ); i--)
      s3++;
  ...
  let n = 0;
  for (let s3 = r2.length - 1; s3 >= 0 && r2[s3].every(
    (l) => M(l.cell) && l.rowspan === 1
  ); s3--)
    n++;
  const e = Math.min(n, r2.length - 1);
  return r2.splice(r2.length - e, e), I(r2);
}
function $t(t, o, r2, n = x(t)) {
  const { width: e, height: s3 } = tt(t);
  if (o === "columns")
    n.forEach((i, l) => {
      if (r2 >= 0)
    ...
    for (let i = 0; i < r2; i++) {
      const l = new Array(e).fill(null).map((a3, c) => ({
        row: s3 + i,
        col: c,
        rowspan: 1,
        colspan: 1,
  ...
  else r2 < 0 && n.splice(s3 + r2, -1 * r2);
  return I(n);
}
function Jt(t, o, r2) {
  const n = yt(t, r2);
  if (!n.some((a3) => D(a3.cell) > 1))
    return true;
  let s3 = r2, i = r2;
  return n.forEach((a3) => {
    const c = D(a3.cell);
    s3 = Math.max(s3, a3.row + c - 1), i = Math.min(i, a3.row);
  }), o < r2 ? r2 === s3 : r2 === i;
}
function _t(t, o, r2) {
  const n = Ct(t, r2);
  if (!n.some((a3) => A(a3.cell) > 1))
    return true;
  let s3 = r2, i = r2;
  return n.forEach((a3) => {
    const c = A(a3.cell);
    s3 = Math.max(s3, a3.col + c - 1), i = Math.min(i, a3.col);
  }), o < r2 ? r2 === s3 : r2 === i;
}
function Ht(t, o, r2) {
  const n = E(t, r2), e = E(o, r2);
  return n.col === e.col;
}
function V(t, o, r2, n) {
  const e = [];
  for (const [i, l] of Object.entries(t.styles || {})) {
    ...
    if (a3.propSchema === "boolean")
      l && e.push(o.mark(i));
    else if (a3.propSchema === "string")
      l && e.push(o.mark(i, { stringValue: l }));
    else
      throw new O(a3.propSchema);
  }
...
function T(t, o, r2, n = N(o)) {
  const e = [];
  for (const s3 of t)
    typeof s3 == "string" ? e.push(
      ...P(s3, o, n, r2)
    ) : X(s3) ? e.push(...mt(s3, o, n)) : B(s3) ? e.push(
      ...P([s3], o, n, r2)
    ) : e.push(
      nt(s3, o, n)
    );
...
function kt(t, o, r2 = N(o)) {
  const n = [], e = new Array(t.headerRows ?? 0).fill(true), s3 = new Array(t.headerCols ?? 0).fill(true), i = t.columnWidths ?? [];
  for (let l = 0; l < t.rows.length; l++) {
    const a3 = t.rows[l], c = [], h3 = e[l];
    for (let p2 = 0; p2 < a3.cells.length; p2++) {
      const u = a3.cells[p2], g = s3[p2], C2 = void 0;
      let d = null;
      const w = E(
        {
          row: l,
      ...
      if (u) if (typeof u == "string")
        ...
        const b4 = A(u);
        b4 > 1 && (y2 = new Array(b4).fill(false).map((k, W2) => i[w.col + W2] ?? void 0));
      } else
        d = T(
          u,
          o,
      ...
      const m = o.nodes[g || h3 ? "tableHeader" : "tableCell"].createChecked(
        {
          ...v(u) ? u.props : {},
          colwidth: y2
        },
        o.nodes.tableParagraph.createChecked(C2, d)
      );
      c.push(m);
    }
    const f3 = o.nodes.tableRow.createChecked({}, c);
    n.push(f3);
  }
  return n;
}
function nt(t, o, r2) {
  ...
  if (!t.content)
    ...
    n = o.nodes[e].createChecked(t.props, s3);
    ...
    const s3 = kt(t.content, o, r2);
    n = o.nodes[e].createChecked(t.props, s3);
  } else
    throw new O(t.content.type);
  return n;
}
function bt(t, o, r2 = N(o)) {
  let n = t.id;
...
var TableMap = class {
  ...
  findCell(pos) {
    for (let i = 0; i < this.map.length; i++) {
      ...
      let right = left + 1;
      let bottom = top + 1;
      for (let j3 = 1; right < this.width && this.map[i + j3] == curPos; j3++) right++;
      for (let j3 = 1; bottom < this.height && this.map[i + this.width * j3] == curPos; j3++) bottom++;
      return {
        left,
        top,
        right,
  ...
  rectBetween(a3, b4) {
    const { left: leftA, right: rightA, top: topA, bottom: bottomA } = this.findCell(a3);
...
function findBadColWidths(map3, colWidths, table2) {
  ...
  for (let i = 0; i < map3.map.length; i++) {
    ...
    for (let j3 = 0; j3 < attrs.colspan; j3++) {
      const colWidth = colWidths[(i + j3) % map3.width * 2];
...
var CellSelection = class CellSelection2 extends Selection {
  constructor($anchorCell, $headCell = $anchorCell) {
    ...
    const ranges = cells.map((pos) => {
      ...
      return new SelectionRange(doc2.resolve(from3), doc2.resolve(from3 + cell.content.size));
    });
  ...
  forEachCell(f3) {
    ...
    for (let i = 0; i < cells.length; i++) f3(table2.nodeAt(cells[i]), tableStart + cells[i]);
  }
  isColSelection() {
...
function changedDescendants(old, cur, offset, f3) {
  ...
  outer: for (let i = 0, j3 = 0; i < curSize; i++) {
    const child = cur.child(i);
    for (let scan = j3, e = Math.min(oldSize, i + 3); scan < e; scan++) if (old.child(scan) == child) {
      j3 = scan + 1;
  ...
  if (dispatch) {
    ...
    for (let row = rect.top; row < rect.bottom; row++) for (let col = rect.left; col < rect.right; col++) {
      ...
      if (mergedPos == null) {
        ...
        if (!isEmpty(cell)) content3 = content3.append(cell.content);
    ...
    if (content3.size > 0) {
      ...
      tr.replaceWith(start + rect.tableStart, end + rect.tableStart, content3);
    }
...
function pastedCells(slice) {
  ...
  else if (role == "cell" || role == "header_cell") rows.push(openStart || openEnd ? fitSlice(tableNodeTypes(schema).row, new Slice(content3, openStart, openEnd)).content : content3);
  else return null;
...
function growTable(tr, map3, table2, start, width, height, mapFrom) {
  ...
  if (height > map3.height) {
    ...
    for (let i = 0, start$1 = (map3.height - 1) * map3.width; i < Math.max(map3.width, width); i++) {
      const header = i >= map3.width ? false : table2.nodeAt(map3.map[start$1 + i]).type == types.header_cell;
...
function isolateHorizontal(tr, map3, table2, start, left, right, top, mapFrom) {
  ...
  for (let col = left; col < right; col++) {
    ...
    if (map3.map[index - map3.width] == pos) {
      ...
      tr.insert(tr.mapping.slice(mapFrom).map(map3.positionAt(top, cellLeft, table2)), cell.type.createAndFill({
        ...cell.attrs,
...
function insertCells(state, dispatch, tableStart, rect, cells) {
  ...
  for (let row = top; row < bottom; row++) {
    const from3 = map3.positionAt(row, left, table2), to = map3.positionAt(row, right, table2);
    tr.replace(tr.mapping.slice(mapFrom).map(from3 + tableStart), tr.mapping.slice(mapFrom).map(to + tableStart), new Slice(cells.rows[row - top], 0, 0));
  }
  recomp();
...
function updateColumnsOnResize(node, colgroup, table2, defaultCellMinWidth, overrideCol, overrideValue) {
  let totalWidth = 0;
  let fixedWidth = true;
  ...
  for (let i = 0, col = 0; i < row.childCount; i++) {
    ...
    for (let j3 = 0; j3 < colspan; j3++, col++) {
      const hasWidth = overrideCol == col ? overrideValue : colwidth && colwidth[j3];
...
function handleDecorations(state, cell) {
  ...
  for (let row = 0; row < map3.height; row++) {
    ...
    if ((col == map3.width - 1 || map3.map[index] != map3.map[index + 1]) && (row == 0 || map3.map[index] != map3.map[index - map3.width])) {
      ...
      if ((_columnResizingPlugin = columnResizingPluginKey.getState(state)) === null || _columnResizingPlugin === void 0 ? void 0 : _columnResizingPlugin.dragging) decorations.push(Decoration.node(start + cellPos, start + cellPos + table2.nodeAt(cellPos).nodeSize, { class: "column-resize-dragging" }));
...
function __flush_internals(relatedVals) {
  const sorted = Array.from(relatedVals).sort((a3, b4) => {
    if (a3 instanceof Derived && a3.options.deps.includes(b4)) return 1;
    if (b4 instanceof Derived && b4.options.deps.includes(a3)) return -1;
    return 0;
  });
...
var Store = class {
  constructor(initialState, options) {
    ...
    this.subscribe = (listener) => {
      ...
      const unsub = (_b = (_a2 = this.options) == null ? void 0 : _a2.onSubscribe) == null ? void 0 : _b.call(_a2, listener, this);
      return () => {
...
var Derived = class _Derived {
  constructor(options) {
    ...
    this.recompute = () => {
      ...
      (_b = (_a2 = this.options).onUpdate) == null ? void 0 : _b.call(_a2);
    };
    ...
    this.subscribe = (listener) => {
      var _a2, _b;
      this.listeners.add(listener);
      const unsub = (_b = (_a2 = this.options).onSubscribe) == null ? void 0 : _b.call(_a2, listener, this);
      return () => {
        this.listeners.delete(listener);
        unsub == null ? void 0 : unsub();
      };
...
// node_modules/@blocknote/core/dist/BlockNoteExtension-C2X7LW-V.js
var r = /* @__PURE__ */ Symbol("originalFactory");
function a(n) {
...
var ObservableV2 = class {
   ...
   */
  emit(name, args2) {
    return from2((this._observers.get(name) || create()).values()).forEach((f3) => f3(...args2));
  }
  destroy() {
    this._observers = create();
  }
...
var abs = Math.abs;
var min = (a3, b4) => a3 < b4 ? a3 : b4;
var max = (a3, b4) => a3 > b4 ? a3 : b4;
...
var equals = (a3, b4) => a3 === b4 || !!a3?.[EqualityTraitSymbol]?.(b4) || false;
...
var equalFlat = (a3, b4) => a3 === b4 || size(a3) === size(b4) && every2(a3, (val, key) => (val !== void 0 || hasProperty(b4, key)) && equals(b4[key], val));
...
var id = (a3) => a3;
var equalityDeep = (a3, b4) => {
  if (a3 === b4) {
    return true;
  }
  if (a3 == null || b4 == null || a3.constructor !== b4.constructor && (a3.constructor || Object) !== (b4.constructor || Object)) {
    return false;
  }
  if (a3[EqualityTraitSymbol] != null) {
    return a3[EqualityTraitSymbol](b4);
  }
  switch (a3.constructor) {
    ...
    case Map: {
      ...
      for (const key of a3.keys()) {
        if (!b4.has(key) || !equalityDeep(a3.get(key), b4.get(key))) {
          return false;
        }
      }
      break;
    ...
    case Object:
      ...
      for (const key in a3) {
        if (!hasProperty(a3, key) || !equalityDeep(a3[key], b4[key])) {
          return false;
        }
      }
      break;
...
var ValidationError = class {
  ...
  toString() {
    ...
    for (let i = this._rerrs.length - 1; i > 0; i--) {
      ...
      s3.push(repeat(" ", (this._rerrs.length - i) * 2) + `${r2.path != null ? `[${r2.path}] ` : ""}${r2.has} doesn't match ${r2.expected}. ${r2.message}`);
    }
    return s3.join("\n");
  }
};
var shapeExtends = (a3, b4) => {
  if (a3 === b4) return true;
  if (a3 == null || b4 == null || a3.constructor !== b4.constructor) return false;
  if (a3[EqualityTraitSymbol]) return equals(a3, b4);
  if (isArray(a3)) {
    return every(
      a3,
      (aitem) => some(b4, (bitem) => shapeExtends(aitem, bitem))
    );
  } else if (isObject(a3)) {
    return every2(
      a3,
      (aitem, akey) => shapeExtends(aitem, b4[akey])
    );
  }
  return false;
};
...
var $Literal = class extends Schema {
   ...
   */
  check(o, err) {
    const c = this.shape.some((a3) => a3 === o);
...
var _schemaStringTemplateToRegex = (s3) => {
  if ($string.check(s3)) {
...
var $Array = class extends Schema {
  ...
  constructor(v6) {
    super();
    this.shape = v6.length === 1 ? v6[0] : new $Union(v6);
  }
  /**
   * @param {any} o
   * @param {ValidationError} [err]
...
var $Lambda = class extends Schema {
   ...
   */
  check(f3, err) {
    const c = f3.constructor === Function && f3.length <= this.len;
    !c && err?.extend(null, "function", typeof f3);
    return c;
  }
};
...
var $union = (...schemas) => schemas.findIndex(($s) => $$union.check($s)) >= 0 ? $union(...schemas.map(($s) => $2($s)).map(($s) => $$union.check($s) ? $s.shape : [$s]).flat(1)) : schemas.length === 1 ? schemas[0] : new $Union(schemas);
var $$union = (
...
var $$any = (
  ...
  $constructedBy($Custom, (o) => o.shape === _t2)
);
...
var iterateDeletedStructs = (transaction, ds, f3) => ds.clients.forEach((deletes, clientid) => {
  const structs = (
    /** @type {Array<GC|Item>} */
...
var sortAndMergeDeleteSet = (ds) => {
  ds.clients.forEach((dels) => {
    dels.sort((a3, b4) => a3.clock - b4.clock);
    let i, j3;
    for (i = 1, j3 = 1; i < dels.length; i++) {
      const left = dels[j3 - 1];
      const right = dels[i];
      if (left.clock + left.len >= right.clock) {
        dels[j3 - 1] = new DeleteItem(left.clock, max(left.len, right.clock + right.len - left.clock));
      } else {
        if (j3 < i) {
          dels[j3] = right;
        }
...
var writeDeleteSet = (encoder, ds) => {
  ...
  from2(ds.clients.entries()).sort((a3, b4) => b4[0] - a3[0]).forEach(([client, dsitems]) => {
...
var writeClientsStructs = (encoder, store, _sm) => {
  ...
  from2(sm.entries()).sort((a3, b4) => b4[0] - a3[0]).forEach(([client, clock]) => {
    writeStructs(
      encoder,
      /** @type {Array<GC|Item>} */
...
var integrateStructs = (transaction, store, clientsStructRefs) => {
  const stack = [];
  let clientsStructRefsIds = from2(clientsStructRefs.keys()).sort((a3, b4) => a3 - b4);
...
var writeStateVector = (encoder, sv) => {
  ...
  from2(sv.entries()).sort((a3, b4) => b4[0] - a3[0]).forEach(([client, clock]) => {
    writeVarUint(encoder.restEncoder, client);
    writeVarUint(encoder.restEncoder, clock);
  });
  return encoder;
...
var compareIDs = (a3, b4) => a3 === b4 || a3 !== null && b4 !== null && a3.client === b4.client && a3.clock === b4.clock;
...
var compareRelativePositions = (a3, b4) => a3 === b4 || a3 !== null && b4 !== null && a3.tname === b4.tname && compareIDs(a3.item, b4.item) && compareIDs(a3.type, b4.type) && a3.assoc === b4.assoc;
var Snapshot = class {
  /**
   * @param {DeleteSet} ds
...
var transact = (doc2, f3, origin = null, local = true) => {
...
var markPosition = (searchMarker, p2, index) => {
  if (searchMarker.length >= maxSearchMarker) {
    const marker = searchMarker.reduce((a3, b4) => a3.timestamp < b4.timestamp ? a3 : b4);
...
var findMarker = (yarray, index) => {
  ...
  const marker = yarray._searchMarker.length === 0 ? null : yarray._searchMarker.reduce((a3, b4) => abs(index - a3.index) < abs(index - b4.index) ? a3 : b4);
...
var typeListInsertGenerics = (transaction, parent, index, content3) => {
  if (index > parent._length) {
    throw lengthExceeded();
  }
  if (index === 0) {
    if (parent._searchMarker) {
      updateMarkerChanges(parent._searchMarker, index, content3.length);
    }
  ...
  return typeListInsertGenericsAfter(transaction, parent, n, content3);
};
    ...
    switch (value.constructor) {
      ...
      default:
        if (value instanceof AbstractType) {
          content3 = new ContentType(value);
        } else {
...
var YArray = class _YArray extends AbstractType {
  ...
  insert(index, content3) {
    if (this.doc !== null) {
      ...
      this._prelimContent.splice(index, 0, ...content3);
    }
  }
  /**
  ...
  toJSON() {
    ...
    this._map.forEach((item, key) => {
      if (!item.deleted) {
        ...
        map3[key] = v6 instanceof AbstractType ? v6.toJSON() : v6;
      }
    });
    return map3;
  }
...
var equalAttrs = (a3, b4) => a3 === b4 || typeof a3 === "object" && typeof b4 === "object" && a3 && b4 && equalFlat(a3, b4);
...
var insertText = (transaction, parent, currPos, text4, attributes) => {
  ...
  const content3 = text4.constructor === String ? new ContentString(
    /** @type {string} */
    text4
  ) : text4 instanceof AbstractType ? new ContentType(text4) : new ContentEmbed(text4);
    ...
    if (!start.deleted) {
      ...
      switch (content3.constructor) {
        case ContentFormat: {
          ...
          if (endFormats.get(key) !== content3 || startAttrValue === value) {
...
var YText = class _YText extends AbstractType {
   ...
   */
  clone() {
    const text4 = new _YText();
    text4.applyDelta(this.toDelta());
    return text4;
  }
  /**
  ...
  insert(index, text4, attributes) {
    ...
    if (y2 !== null) {
      transact(y2, (transaction) => {
        ...
        if (!attributes) {
          attributes = {};
          pos.currentAttributes.forEach((v6, k) => {
            attributes[k] = v6;
          });
        }
        insertText(transaction, this, pos, text4, attributes);
      });
    } else {
      this._pending.push(() => this.insert(index, text4, attributes));
    }
  }
  /**
...
var YXmlTreeWalker = class {
   ...
   */
  constructor(root3, f3 = () => true) {
    this._filter = f3;
    this._root = root3;
    this._currentNode = /** @type {Item} */
    root3._start;
    this._firstCall = true;
    root3.doc ?? warnPrematureAccess();
  }
  [Symbol.iterator]() {
    return this;
  }
...
var YXmlFragment = class _YXmlFragment extends AbstractType {
  ...
  insert(index, content3) {
    if (this.doc !== null) {
      transact(this.doc, (transaction) => {
        typeListInsertGenerics(transaction, this, index, content3);
      });
    } else {
      this._prelimContent.splice(index, 0, ...content3);
    }
...
var YXmlElement = class _YXmlElement extends YXmlFragment {
  ...
  clone() {
    ...
    el.insert(0, this.toArray().map((v6) => v6 instanceof AbstractType ? v6.clone() : v6));
    return el;
  }
  /**
  ...
  toString() {
    return this.toDelta().map((delta) => {
      ...
      for (const nodeName in delta.attributes) {
        ...
        attrs.sort((a3, b4) => a3.key < b4.key ? -1 : 1);
        nestedNodes.push({ nodeName, attrs });
      }
      nestedNodes.sort((a3, b4) => a3.nodeName < b4.nodeName ? -1 : 1);
      let str = "";
...
var simpleDiffString = (a3, b4) => {
  let left = 0;
  let right = 0;
  while (left < a3.length && left < b4.length && a3[left] === b4[left]) {
    left++;
  }
  if (left > 0 && highSurrogateRegex.test(a3[left - 1])) left--;
  while (right + left < a3.length && right + left < b4.length && a3[a3.length - right - 1] === b4[b4.length - right - 1]) {
    right++;
  }
  if (right > 0 && lowSurrogateRegex.test(a3[a3.length - right])) right--;
  return {
    index: left,
    remove: a3.length - left - right,
    insert: b4.slice(left, b4.length - right)
  };
};
...
var Hasher = class {
  ...
  _updateHash() {
    ...
    let g = H3[6];
    let h3 = H3[7];
    for (let tt2 = 0, T1, T22; tt2 < 64; tt2++) {
      T1 = h3 + sum1to256(e) + (e & f3 ^ ~e & g) + K2[tt2] + W2[tt2] >>> 0;
      T22 = sum0to256(a3) + (a3 & b4 ^ a3 & c ^ b4 & c) >>> 0;
      h3 = g;
      g = f3;
      f3 = e;
      e = d + T1 >>> 0;
  ...
  digest(data) {
    ...
    for (; i + 56 <= data.length; ) {
      let j4 = 0;
      for (; j4 < 16 && i + 3 < data.length; j4++) {
        this._W[j4] = data[i++] << 24 | data[i++] << 16 | data[i++] << 8 | data[i++];
      }
      if (i % 64 !== 0) {
        this._W.fill(0, j4, 16);
        while (i < data.length) {
          this._W[j4] |= data[i] << (3 - i % 4) * 8;
          i++;
        }
        this._W[j4] |= BIT8 << (3 - i % 4) * 8;
      }
      this._updateHash();
    }
    ...
    this._W.fill(0, 0, 16);
    let j3 = 0;
    for (; i < data.length; j3++) {
      for (let ci = 3; ci >= 0 && i < data.length; ci--) {
        this._W[j3] |= data[i++] << ci * 8;
      }
    }
    if (!isPaddedWith1) {
      this._W[j3 - (i % 4 === 0 ? 0 : 1)] |= BIT8 << (3 - i % 4) * 8;
    }
...
var createTextNodesFromYText = (text4, schema, _meta, snapshot2, prevSnapshot, computeYChange) => {
  const nodes = [];
  const deltas = text4.toDelta(snapshot2, prevSnapshot, computeYChange);
  try {
    ...
    text4.doc.transact((transaction) => {
      text4._item.delete(transaction);
    }, ySyncPluginKey);
    return null;
  }
  return nodes;
...
var createTypeFromTextNodes = (nodes, meta2) => {
  ...
  const delta = nodes.map((node) => ({
    // @ts-ignore
    insert: node.text,
    attributes: marksToAttributes(node.marks, meta2)
  }));
  type.applyDelta(delta);
  meta2.mapping.set(type, nodes);
  return type;
};
var createTypeFromElementNode = (node, meta2) => {
  ...
  meta2.mapping.set(type, node);
  return type;
};
var createTypeFromTextOrElementNode = (node, meta2) => node instanceof Array ? createTypeFromTextNodes(node, meta2) : createTypeFromElementNode(node, meta2);
...
var equalAttrs2 = (pattrs, yattrs) => {
  ...
  for (let i = 0; i < keys2.length && eq; i++) {
    ...
    const l = pattrs[key];
    const r2 = yattrs[key];
    eq = key === "ychange" || l === r2 || isObject2(l) && isObject2(r2) && equalAttrs2(l, r2);
  }
  return eq;
};
...
var updateYText = (ytext, ptexts, meta2) => {
  ...
  const content3 = ptexts.map((p2) => ({
    insert: (
      /** @type {any} */
      p2.text
    ),
    attributes: Object.assign({}, nAttrs, marksToAttributes(p2.marks, meta2))
  }));
...
var marksToAttributes = (marks, meta2) => {
  ...
  marks.forEach((mark) => {
    if (mark.type.name !== "ychange") {
      const isOverlapping = setIfUndefined(meta2.isOMark, mark.type, () => !mark.type.excludes(mark.type));
...
var DecorationCache = class DecorationCache2 {
  constructor(cache) {
  ...
  */
  invalidate(tr) {
    const returnCache = new DecorationCache2(this.cache);
...
function createParser(highlighter, options) {
  return function parser({ content: content3, language, pos, size: size2 }) {
    const decorations = [];
    const { tokens, fg, bg, rootStyle } = highlighter.codeToTokens(content3, {
      lang: language,
    ...
    for (const line of tokens) {
      for (const token of line) {
        const to = from3 + token.content.length;
...
// node_modules/@blocknote/core/dist/defaultBlocks-DE5GNdJH.js
var Oe = Object.defineProperty;
var _e = (e, t, n) => t in e ? Oe(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var M2 = (e, t, n) => _e(e, typeof t != "symbol" ? t + "" : t, n);
var mt2 = () => typeof navigator < "u" && (/Mac/.test(navigator.platform) || /AppleWebKit/.test(navigator.userAgent) && /Mobile\/\w+/.test(navigator.userAgent));
function L2(e, t = "Ctrl") {
  return mt2() ? e.replace("Mod", "⌘") : e.replace("Mod", t);
}
function D2(...e) {
  return [
...
var uo = () => /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
function gt2(e, t, n, o) {
  const r2 = document.createElement("div");
  r2.className = D2(
    "bn-block-content",
    n.class
  ), r2.setAttribute("data-content-type", e);
  for (const [s3, i] of Object.entries(n))
    s3 !== "class" && r2.setAttribute(s3, i);
  const a3 = document.createElement(t);
  a3.className = D2(
    "bn-inline-content",
    o.class
  );
  for (const [s3, i] of Object.entries(
    o
  ))
    s3 !== "class" && a3.setAttribute(s3, i);
  return r2.appendChild(a3), {
    dom: r2,
    contentDOM: a3
  };
}
var le = (e, t) => {
  let n = bt(e, t.pmSchema);
...
function bt2(e, t = "<br>") {
  ...
  if (n.length > 1) {
    ...
    for (let r2 = 1; r2 < n.length; r2++) {
      const a3 = n[r2];
      o.innerHTML += t + a3.innerHTML, a3.remove();
    }
  }
}
function R2(e) {
...
function fo(e) {
  ...
  try {
    const r2 = ((n = new URL(e).pathname.split(".").pop()) == null ? void 0 : n.toLowerCase()) || "";
    return t.includes(r2);
  } catch {
    return false;
  }
}
function Ct2(e) {
  ...
  return Object.entries(e).forEach(([n, o]) => {
    t[n] = {
      ...
      // attribute for it.
      parseHTML: (r2) => {
        const a3 = r2.getAttribute(R2(n));
        if (a3 === null)
          return null;
        if (o.default === void 0 && o.type === "boolean" || o.default !== void 0 && typeof o.default == "boolean")
          return a3 === "true" ? true : a3 === "false" ? false : null;
        if (o.default === void 0 && o.type === "number" || o.default !== void 0 && typeof o.default == "number") {
          const s3 = parseFloat(a3);
          return !Number.isNaN(s3) && Number.isFinite(s3) ? s3 : null;
        }
        return a3;
      },
      renderHTML: (r2) => r2[n] !== o.default ? {
        [R2(n)]: r2[n]
      } : {}
    };
  }), t;
}
function kt2(e, t, n, o) {
  const r2 = e();
  if (r2 === void 0)
    throw new Error("Cannot find node position");
  const s3 = n.state.doc.resolve(r2).node().attrs.id;
  if (!s3)
    throw new Error("Block doesn't have id");
  const i = t.getBlock(s3);
  if (i.type !== o)
    throw new Error("Block type does not match");
  return i;
}
function Z2(e, t, n, o, r2 = false, a3) {
  const s3 = document.createElement("div");
  if (a3 !== void 0)
    for (const [i, c] of Object.entries(a3))
      i !== "class" && s3.setAttribute(i, c);
  s3.className = D2(
    "bn-block-content",
    (a3 == null ? void 0 : a3.class) || ""
  ), s3.setAttribute("data-content-type", t);
  for (const [i, c] of Object.entries(n)) {
    const u = o[i].default;
    c !== u && s3.setAttribute(R2(i), c);
  }
  return r2 && s3.setAttribute("data-file-block", ""), s3.appendChild(e.dom), e.contentDOM && (e.contentDOM.className = D2(
    "bn-inline-content",
...
function Et(e, t) {
  ...
  return t.parse && n.push({
    ...
    getContent: e.content === "inline" || e.content === "none" ? (o, r2) => {
      ...
      if (e.content === "inline") {
        const i = o.cloneNode(true);
        return bt2(
          i,
          (a3 = t.meta) != null && a3.code ? `
` : "<br>"
        ), DOMParser2.fromSchema(r2).parse(i, {
          topNode: r2.nodes.paragraph.create(),
          preserveWhitespace: true
        }).content;
      }
...
function ho(e, t, n, o) {
  var a3, s3, i, c;
  const r2 = t.node || Node3.create({
    name: e.type,
    content: e.content === "inline" ? "inline*" : e.content === "none" ? "" : e.content,
    group: "blockContent",
    selectable: ((a3 = t.meta) == null ? void 0 : a3.selectable) ?? true,
    isolating: ((s3 = t.meta) == null ? void 0 : s3.isolating) ?? true,
    code: ((i = t.meta) == null ? void 0 : i.code) ?? false,
    defining: ((c = t.meta) == null ? void 0 : c.defining) ?? true,
    priority: o,
    addAttributes() {
      return Ct2(e.propSchema);
    },
    parseHTML() {
      return Et(e, t);
    },
    ...
    addNodeView() {
      return (l) => {
        var f3, E3;
        const u = this.options.editor, d = kt2(
          l.getPos,
          u,
          this.editor,
          e.type
        ), p2 = ((f3 = this.options.domAttributes) == null ? void 0 : f3.blockContent) || {}, m = t.render.call(
          { blockContentDOMAttributes: p2, props: l, renderType: "nodeView" },
          d,
          u
        );
        return ((E3 = t.meta) == null ? void 0 : E3.selectable) === false && yt2(m, this.editor), m;
      };
    }
  });
  if (r2.name !== e.type)
  ...
  return {
    ...
    implementation: {
      ...
      render(l, u) {
        var p2;
        const d = ((p2 = r2.options.domAttributes) == null ? void 0 : p2.blockContent) || {};
      ...
      toExternalHTML: (l, u, d) => {
        var m, f3;
        const p2 = ((m = r2.options.domAttributes) == null ? void 0 : m.blockContent) || {};
        return ((f3 = t.toExternalHTML) == null ? void 0 : f3.call(
          { blockContentDOMAttributes: p2 },
          l,
          u,
          d
        )) ?? t.render.call(
          { blockContentDOMAttributes: p2, renderType: "dom", props: void 0 },
          l,
          u
        );
      }
...
function y(e, t, n) {
  return (o = {}) => {
    const r2 = typeof e == "function" ? e(o) : e, a3 = typeof t == "function" ? t(o) : t, s3 = n ? typeof n == "function" ? n(o) : n : void 0;
    return {
      config: r2,
      implementation: {
        ...a3,
        ...
        toExternalHTML(i, c, l) {
          var d, p2;
          const u = (d = a3.toExternalHTML) == null ? void 0 : d.call(
          ...
          if (u !== void 0)
            return Z2(
              ...
              i.props,
              r2.propSchema,
              ((p2 = a3.meta) == null ? void 0 : p2.fileBlockAccept) !== void 0
            );
        },
        render(i, c) {
          var d;
          const l = a3.render.call(
            {
              blockContentDOMAttributes: this.blockContentDOMAttributes,
          ...
          return Z2(
            ...
            i.props,
            r2.propSchema,
            ((d = a3.meta) == null ? void 0 : d.fileBlockAccept) !== void 0,
...
function go(e, t, n, o) {
  return e.dom.setAttribute("data-inline-content-type", t), Object.entries(n).filter(([r2, a3]) => {
    const s3 = o[r2];
    return a3 !== s3.default;
  }).map(([r2, a3]) => [R2(r2), a3]).forEach(([r2, a3]) => e.dom.setAttribute(r2, a3)), e.contentDOM && e.contentDOM.setAttribute("data-editable", ""), e;
}
function bo(e) {
  return {
    Backspace: ({ editor: t }) => {
...
function H2(e, t) {
  return Me(
    ...
    },
    {
      mark: e,
      render(n, o) {
        const r2 = o.pmSchema.marks[e.name].spec.toDOM;
        if (r2 === void 0)
          throw new Error(
            "This block has no default HTML serialization as its corresponding TipTap node doesn't implement `renderHTML`."
          );
        const a3 = o.pmSchema.mark(e.name, {
          stringValue: n
        }), s3 = DOMSerializer.renderSpec(
          document,
          r2(a3, true)
        );
        if (typeof s3 != "object" || !("dom" in s3))
          throw new Error(
  ...
  const n = [
    {
      ...
      contentElement: (o) => {
        const r2 = o;
        return r2.matches("[data-editable]") ? r2 : r2.querySelector("[data-editable]") || r2;
      }
    }
  ];
  return t && n.push({
    ...
    getAttrs(o) {
      if (typeof o == "string")
        return false;
      const r2 = t == null ? void 0 : t(o);
      return r2 === void 0 ? false : { stringValue: r2 };
    }
  }), n;
}
function Le(e, t) {
  const n = Mark.create({
    name: e.type,
    addAttributes() {
      return wt2(e.propSchema);
    },
    parseHTML() {
      return Lt(e, t.parse);
    },
    renderHTML({ mark: o }) {
      const r2 = (t.toExternalHTML || t.render)(o.attrs.stringValue);
      return V2(
        r2,
        e.type,
        o.attrs.stringValue,
    ...
    addMarkView() {
      return ({ mark: o }) => {
        const r2 = t.render(o.attrs.stringValue);
        return V2(
          r2,
          e.type,
          o.attrs.stringValue,
  ...
  return Me(e, {
    ...
    toExternalHTML: (o) => {
      const r2 = (t.toExternalHTML || t.render)(o);
      return V2(
        r2,
        e.type,
        o,
...
function Tt2(e, t) {
  let n, o;
  if (t.firstChild.descendants((r2, a3) => n ? false : !Bt(r2) || r2.attrs.id !== e ? true : (n = r2, o = a3 + 1, false)), !(n === void 0 || o === void 0))
    return {
      node: n,
      posBeforeNode: o
    };
...
function K3(e, t, n, o, r2) {
  const a3 = It(e.doc.resolve(t));
  let s3 = null;
  a3.blockNoteType === "table" && (s3 = Pt2(e));
  const i = ht(e);
  if (o !== void 0 && r2 !== void 0 && o > r2)
    throw new Error("Invalid replaceFromPos or replaceToPos");
  const c = i.nodes[a3.blockNoteType], l = i.nodes[n.type || a3.blockNoteType], u = l.isInGroup("bnBlock") ? l : i.nodes.blockContainer;
  if (a3.isBlockContainer && l.isInGroup("blockContent")) {
    const d = o !== void 0 && o > a3.blockContent.beforePos && o < a3.blockContent.afterPos ? o - a3.blockContent.beforePos - 1 : void 0, p2 = r2 !== void 0 && r2 > a3.blockContent.beforePos && r2 < a3.blockContent.afterPos ? r2 - a3.blockContent.beforePos - 1 : void 0;
    de(n, e, a3), At2(
      n,
      e,
      c,
  ...
  } else if (!a3.isBlockContainer && l.isInGroup("bnBlock"))
    de(n, e, a3);
  else {
    const d = L(a3.bnBlock.node, i);
    e.replaceWith(
      a3.bnBlock.beforePos,
      a3.bnBlock.afterPos,
      bt(
        {
          children: d.children,
  ...
  e.setNodeMarkup(a3.bnBlock.beforePos, u, {
    ...a3.bnBlock.node.attrs,
    ...n.props
  }), s3 && Nt(e, a3, s3);
}
function At2(e, t, n, o, r2, a3, s3) {
  const i = ht(t);
  let c = "keep";
  if (e.content)
  ...
  if (c === "keep")
    t.setNodeMarkup(r2.blockContent.beforePos, o, {
      ...r2.blockContent.node.attrs,
      ...e.props
    });
  else if (a3 !== void 0 || s3 !== void 0) {
    t.setNodeMarkup(r2.blockContent.beforePos, o, {
      ...r2.blockContent.node.attrs,
      ...e.props
    });
    const l = r2.blockContent.beforePos + 1 + (a3 ?? 0), u = r2.blockContent.beforePos + 1 + (s3 ?? r2.blockContent.node.content.size), d = t.doc.resolve(r2.blockContent.beforePos).depth, p2 = t.doc.resolve(l).depth, m = t.doc.resolve(u).depth;
    t.replace(
      l,
      u,
      new Slice(
...
function de(e, t, n) {
  ...
  if (e.children !== void 0 && e.children.length > 0) {
    const r2 = e.children.map((a3) => bt(a3, o));
    if (n.childContainer)
      t.step(
        new ReplaceStep(
...
function vo(e, t, n, o, r2) {
  const a3 = typeof t == "string" ? t : t.id, s3 = Tt2(a3, e.doc);
  if (!s3)
    throw new Error(`Block with ID ${a3} not found`);
  K3(
    e,
    s3.posBeforeNode,
    n,
  ...
  const i = e.doc.resolve(s3.posBeforeNode + 1).node(), c = ht(e);
  return L(i, c);
}
function Pt2(e) {
  ...
  let o = -1, r2 = -1;
  for (let S3 = n.depth; S3 >= 0; S3--) {
    const x2 = n.node(S3).type.name;
    if (o < 0 && (x2 === "tableCell" || x2 === "tableHeader") && (o = S3), x2 === "table") {
      r2 = S3;
      break;
    }
  }
  if (o < 0 || r2 < 0)
    return null;
  const a3 = n.before(o), s3 = n.before(r2), i = e.doc.nodeAt(s3);
  if (!i || i.type.name !== "table")
    return null;
  const c = TableMap.get(i), l = a3 - (s3 + 1), u = c.map.indexOf(l);
  if (u < 0)
    return null;
  const d = Math.floor(u / c.width), p2 = u % c.width, f3 = a3 + 1 + 1, E3 = Math.max(0, t.head - f3);
  return { row: d, col: p2, offset: E3 };
}
function Nt(e, t, n) {
  var S3;
  ...
  if (t.isBlockContainer)
    ...
    const x2 = e.mapping.map(t.bnBlock.beforePos), P2 = x2 + (((S3 = e.doc.nodeAt(x2)) == null ? void 0 : S3.nodeSize) || 0);
    e.doc.nodesBetween(x2, P2, (g, w) => g.type.name === "table" ? (o = w, false) : true);
  }
  const r2 = o >= 0 ? e.doc.nodeAt(o) : null;
  if (!r2 || r2.type.name !== "table")
    return false;
  const a3 = TableMap.get(r2), s3 = Math.max(0, Math.min(n.row, a3.height - 1)), i = Math.max(0, Math.min(n.col, a3.width - 1)), c = s3 * a3.width + i, l = a3.map[c];
  if (l == null)
    return false;
  const d = o + 1 + l + 1, p2 = e.doc.nodeAt(d), m = d + 1, f3 = p2 ? p2.content.size : 0, E3 = m + Math.max(0, Math.min(n.offset, f3));
  return "selection" in e && e.setSelection(TextSelection.create(e.doc, E3)), true;
}
var T2 = {
  gray: {
    text: "#9b9a97",
...
var A2 = (e, t) => {
  e.backgroundColor && e.backgroundColor !== h.backgroundColor.default && (t.style.backgroundColor = e.backgroundColor in T2 ? T2[e.backgroundColor].background : e.backgroundColor), e.textColor && e.textColor !== h.textColor.default && (t.style.color = e.textColor in T2 ? T2[e.textColor].text : e.textColor), e.textAlignment && e.textAlignment !== h.textAlignment.default && (t.style.textAlign = e.textAlignment);
};
var Eo = (e = "backgroundColor") => ({
...
var $3 = (e, t) => {
  ...
  return { targetElement: n, caption: r2 };
};
var I2 = a(({ editor: e }) => {
  const t = f2(void 0);
  function n() {
...
var Ht2 = (e, t, n) => {
  ...
  const r2 = document.createElement("div");
  r2.className = "bn-add-file-button-icon", n ? r2.appendChild(n) : r2.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 8L9.00319 2H19.9978C20.5513 2 21 2.45531 21 2.9918V21.0082C21 21.556 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5501 3 20.9932V8ZM10 4V9H5V20H19V4H10Z"></path></svg>', o.appendChild(r2);
  const a3 = document.createElement("p");
  a3.className = "bn-add-file-button-text", a3.innerHTML = e.type in t.dictionary.file_blocks.add_button_text ? t.dictionary.file_blocks.add_button_text[e.type] : t.dictionary.file_blocks.add_button_text.file, o.appendChild(a3);
  const s3 = (c) => {
    c.preventDefault(), c.stopPropagation();
  }, i = () => {
    var c;
    t.isEditable && ((c = t.getExtension(I2)) == null || c.showMenu(e.id));
  };
  return o.addEventListener(
    "mousedown",
    s3,
    true
  ), o.addEventListener("click", i, true), {
    dom: o,
    destroy: () => {
...
var It2 = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 8L9.00319 2H19.9978C20.5513 2 21 2.45531 21 2.9918V21.0082C21 21.556 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5501 3 20.9932V8ZM10 4V9H5V20H19V4H10Z"></path></svg>';
var Dt2 = (e) => {
  const t = document.createElement("div");
  t.className = "bn-file-name-with-icon";
  const n = document.createElement("div");
  n.className = "bn-file-icon", n.innerHTML = It2, t.appendChild(n);
...
var Q2 = (e, t, n, o) => {
  const r2 = document.createElement("div");
  if (r2.className = "bn-file-block-content-wrapper", e.props.url === "") {
    const s3 = Ht2(e, t, o);
    r2.appendChild(s3.dom);
    const i = t.onUploadStart((c) => {
      if (c === e.id) {
        r2.removeChild(s3.dom);
        const l = document.createElement("div");
        l.className = "bn-file-loading-preview", l.textContent = "Loading...", r2.appendChild(l);
      }
    });
    return {
      dom: r2,
  ...
  if (e.props.showPreview === false || !n) {
    const s3 = Dt2(e);
    r2.appendChild(s3.dom), a3.destroy = () => {
      var i;
      (i = s3.destroy) == null || i.call(s3);
    };
  } else
    r2.appendChild(n.dom);
  if (e.props.caption) {
    const s3 = document.createElement("p");
    s3.className = "bn-file-caption", s3.textContent = e.props.caption, r2.appendChild(s3);
  }
  return a3;
};
var J2 = (e, t) => {
...
var ue = (e) => ({ url: e.src || void 0 });
var Ot2 = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M2 16.0001H5.88889L11.1834 20.3319C11.2727 20.405 11.3846 20.4449 11.5 20.4449C11.7761 20.4449 12 20.2211 12 19.9449V4.05519C12 3.93977 11.9601 3.8279 11.887 3.73857C11.7121 3.52485 11.3971 3.49335 11.1834 3.66821L5.88889 8.00007H2C1.44772 8.00007 1 8.44778 1 9.00007V15.0001C1 15.5524 1.44772 16.0001 2 16.0001ZM23 12C23 15.292 21.5539 18.2463 19.2622 20.2622L17.8445 18.8444C19.7758 17.1937 21 14.7398 21 12C21 9.26016 19.7758 6.80629 17.8445 5.15557L19.2622 3.73779C21.5539 5.75368 23 8.70795 23 12ZM18 12C18 10.0883 17.106 8.38548 15.7133 7.28673L14.2842 8.71584C15.3213 9.43855 16 10.64 16 12C16 13.36 15.3213 14.5614 14.2842 15.2841L15.7133 16.7132C17.106 15.6145 18 13.9116 18 12Z"></path></svg>';
var _t3 = (e) => ({
  type: "audio",
  propSchema: {
...
var Vt = (e = {}) => (t) => {
  ...
  if (t.tagName === "FIGURE") {
    ...
    if (!n)
      return;
    const { targetElement: o, caption: r2 } = n, { backgroundColor: a3 } = v2(t);
    return {
      ...ue(o),
      backgroundColor: a3,
      caption: r2
...
var Wt = (e = {}) => (t, n) => {
  const o = document.createElement("div");
  o.innerHTML = e.icon ?? Ot2;
  const r2 = document.createElement("audio");
  return r2.className = "bn-audio", n.resolveFileUrl ? n.resolveFileUrl(t.props.url).then((a3) => {
    r2.src = a3;
  }) : r2.src = t.props.url, r2.controls = true, r2.contentEditable = "false", r2.draggable = false, Q2(
    t,
    n,
    { dom: r2 },
    o.firstElementChild
...
var Rt2 = (e = {}) => (t, n) => {
  if (!t.props.url) {
    ...
    return r2.textContent = "Add audio", {
      dom: r2
    };
  }
  let o;
  return t.props.showPreview ? (o = document.createElement("audio"), o.src = t.props.url) : (o = document.createElement("a"), o.href = t.props.url, o.textContent = t.props.name || t.props.url), t.props.caption ? t.props.showPreview ? J2(o, t.props.caption) : U(o, t.props.caption) : {
    dom: o
  };
};
var Ft = y(
  ...
  (e) => ({
    ...
    parse: Vt(e),
    render: Wt(e),
    toExternalHTML: Rt2(e),
    runsBefore: ["file"]
  })
);
var pe = /* @__PURE__ */ Symbol.for("blocknote.shikiParser");
var j2 = /* @__PURE__ */ Symbol.for(
  ...
  return createHighlightPlugin({
    parser: (s3) => {
      if (!e.createHighlighter)
        return !r2 && (console.log(
          "For syntax highlighting of code blocks, you must provide a `createCodeBlockSpec({ createHighlighter: () => ... })` function"
        ), r2 = true), [];
      if (!n)
        return t[j2] = t[j2] || e.createHighlighter(), t[j2].then(
          (c) => {
            n = c;
          }
        );
      const i = Te(e, s3.language);
      return !i || i === "text" || i === "none" || i === "plaintext" || i === "txt" ? [] : n.getLoadedLanguages().includes(i) ? (o || (o = t[pe] || createParser(n), t[pe] = o), o(s3)) : n.loadLanguage(i);
    },
    languageExtractor: (s3) => s3.attrs.language,
    nodeTypes: ["codeBlock"]
  });
}
var Ut = ({ defaultLanguage: e = "text" }) => ({
  type: "codeBlock",
  propSchema: {
    language: {
      default: e
...
var qt = y(
  ...
  (e) => ({
    ...
    parse: (t) => {
      var r2, a3;
      if (t.tagName !== "PRE" || t.childElementCount !== 1 || ((r2 = t.firstElementChild) == null ? void 0 : r2.tagName) !== "CODE")
        return;
      const n = t.firstElementChild;
      return { language: n.getAttribute("data-language") || ((a3 = n.className.split(" ").find((s3) => s3.includes("language-"))) == null ? void 0 : a3.replace("language-", "")) };
    },
    parseContent: ({ el: t, schema: n }) => {
      const o = DOMParser2.fromSchema(n), r2 = t.firstElementChild;
      return o.parse(r2, {
    ...
    render(t, n) {
      const o = document.createDocumentFragment(), r2 = document.createElement("pre"), a3 = document.createElement("code");
      r2.appendChild(a3);
      let s3;
      if (e.supportedLanguages) {
        ...
        if (Object.entries(e.supportedLanguages ?? {}).forEach(
          ...
          i.addEventListener("change", l), s3 = () => i.removeEventListener("change", l);
        } else
          i.disabled = true;
        const c = document.createElement("div");
        c.contentEditable = "false", c.appendChild(i), o.appendChild(c);
      }
      return o.appendChild(r2), {
        dom: o,
        contentDOM: a3,
        destroy: () => {
          s3 == null || s3();
    ...
    a({
      ...
      keyboardShortcuts: {
        Delete: ({ editor: t }) => t.transact((n) => {
          ...
          if (o.type !== "codeBlock")
            return false;
          const { $from: r2 } = n.selection;
          return r2.parent.textContent ? false : (t.removeBlocks([o]), true);
        }),
        ...
        Enter: ({ editor: t }) => t.transact((n) => {
          const { block: o, nextBlock: r2 } = t.getTextCursorPosition();
          if (o.type !== "codeBlock")
            return false;
          const { $from: a3 } = n.selection, s3 = a3.parentOffset === a3.parent.nodeSize - 2, i = a3.parent.textContent.endsWith(`

`);
          if (s3 && i) {
            if (n.delete(a3.pos - 2, a3.pos), r2)
              return t.setTextCursorPosition(r2, "start"), true;
...
function Te(e, t) {
  ...
  return (n = Object.entries(e.supportedLanguages ?? {}).find(
    ([o, { aliases: r2 }]) => (r2 == null ? void 0 : r2.includes(t)) || o === t
  )) == null ? void 0 : n[0];
}
var jt = () => ({
  type: "divider",
...
var zt = () => (e) => {
  ...
  if (e.tagName === "FIGURE") {
    ...
    if (!t)
      return;
    const { targetElement: n, caption: o } = t, { backgroundColor: r2 } = v2(e);
    return {
      ...fe(n),
      backgroundColor: r2,
      caption: o
...
var Be = (e, t, n, o = Kt) => {
  ...
  const r2 = document.createElement("div"), a3 = document.createElement("div");
  a3.className = "bn-toggle-wrapper";
  const s3 = document.createElement("button");
  s3.className = "bn-toggle-button", s3.type = "button", s3.innerHTML = // https://fonts.google.com/icons?selected=Material+Symbols+Rounded:chevron_right:FILL@0;wght@700;GRAD@0;opsz@24&icon.query=chevron&icon.style=Rounded&icon.size=24&icon.color=%23e8eaed
  '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="CURRENTCOLOR"><path d="M320-200v-560l440 280-440 280Z"/></svg>';
  const i = (f3) => f3.preventDefault();
  s3.addEventListener("mousedown", i);
  const c = () => {
    var f3;
    a3.getAttribute("data-show-children") === "true" ? (a3.setAttribute("data-show-children", "false"), o.set(t.getBlock(e), false), r2.contains(l) && r2.removeChild(l)) : (a3.setAttribute("data-show-children", "true"), o.set(t.getBlock(e), true), t.isEditable && ((f3 = t.getBlock(e)) == null ? void 0 : f3.children.length) === 0 && !r2.contains(l) && r2.appendChild(l));
  };
  s3.addEventListener("click", c), a3.appendChild(s3), a3.appendChild(n);
  const l = document.createElement("button");
  l.className = "bn-toggle-add-block-button", l.type = "button", l.textContent = t.dictionary.toggle_blocks.add_block_button;
  const u = (f3) => f3.preventDefault();
  l.addEventListener(
    "mousedown",
    u
  );
  const d = () => {
    t.transact(() => {
      const f3 = t.updateBlock(e, {
        // Single empty block with default type.
        children: [{}]
      });
      t.setTextCursorPosition(f3.children[0].id, "end"), t.focus();
    });
  };
  l.addEventListener("click", d), r2.appendChild(a3);
  let p2 = e.children.length;
  const m = t.onChange(() => {
    var E3;
    const f3 = ((E3 = t.getBlock(e)) == null ? void 0 : E3.children.length) ?? 0;
    f3 > p2 ? (a3.getAttribute("data-show-children") === "false" && (a3.setAttribute("data-show-children", "true"), o.set(t.getBlock(e), true)), r2.contains(l) && r2.removeChild(l)) : f3 === 0 && f3 < p2 && (a3.getAttribute("data-show-children") === "true" && (a3.setAttribute("data-show-children", "false"), o.set(t.getBlock(e), false)), r2.contains(l) && r2.removeChild(l)), p2 = f3;
  });
  return o.get(e) ? (a3.setAttribute("data-show-children", "true"), t.isEditable && e.children.length === 0 && r2.appendChild(l)) : a3.setAttribute("data-show-children", "false"), {
    dom: r2,
    // Prevents re-renders when the toggle button is clicked.
    ignoreMutation: (f3) => f3 instanceof MutationRecord && // We want to prevent re-renders when the view changes, so we ignore
    // all mutations where the `data-show-children` attribute is changed
    // or the "add block" button is added/removed.
    (f3.type === "attributes" && f3.target === a3 && f3.attributeName === "data-show-children" || f3.type === "childList" && (f3.addedNodes[0] === l || f3.removedNodes[0] === l)),
    destroy: () => {
      s3.removeEventListener("mousedown", i), s3.removeEventListener("click", c), l.removeEventListener(
        "mousedown",
        u
...
var Qt = (e) => ({ editor: t }) => {
  ...
  return t.schema.blockSchema[n.block.type].content !== "inline" ? false : (t.updateBlock(n.block, {
    type: "heading",
    props: { level: e }
  }), true);
};
...
var Pe = (e, t, n, o, r2) => {
  ...
  const m = (g) => {
    ...
    let w;
    const _2 = "touches" in g ? g.touches[0].clientX : g.clientX;
    e.props.textAlignment === "center" ? d.handleUsed === "left" ? w = d.initialWidth + (d.initialClientX - _2) * 2 : w = d.initialWidth + (_2 - d.initialClientX) * 2 : d.handleUsed === "left" ? w = d.initialWidth + d.initialClientX - _2 : w = d.initialWidth + _2 - d.initialClientX, p2 = Math.min(
      Math.max(w, 64),
      ((te2 = (ee2 = t.domElement) == null ? void 0 : ee2.firstElementChild) == null ? void 0 : te2.clientWidth) || Number.MAX_VALUE
    ), i.style.width = `${p2}px`;
  }, f3 = (g) => {
  ...
  return window.addEventListener("mousemove", m), window.addEventListener("touchmove", m), window.addEventListener("mouseup", f3), window.addEventListener("touchend", f3), i.addEventListener("mouseenter", E3), i.addEventListener("mouseleave", S3), c.addEventListener(
    "mousedown",
    x2
  ), c.addEventListener(
    "touchstart",
    ...
    dom: i,
    destroy: () => {
      s3 == null || s3(), window.removeEventListener("mousemove", m), window.removeEventListener("touchmove", m), window.removeEventListener("mouseup", f3), window.removeEventListener("touchend", f3), i.removeEventListener("mouseenter", E3), i.removeEventListener("mouseleave", S3), c.removeEventListener(
        "mousedown",
        x2
...
var en = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M5 11.1005L7 9.1005L12.5 14.6005L16 11.1005L19 14.1005V5H5V11.1005ZM4 3H20C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3ZM15.5 10C14.6716 10 14 9.32843 14 8.5C14 7.67157 14.6716 7 15.5 7C16.3284 7 17 7.67157 17 8.5C17 9.32843 16.3284 10 15.5 10Z"></path></svg>';
var tn = (e = {}) => ({
  type: "image",
  propSchema: {
...
var on = (e = {}) => (t, n) => {
  ...
  const r2 = document.createElement("div");
  r2.className = "bn-visual-media-wrapper";
  const a3 = document.createElement("img");
  return a3.className = "bn-visual-media", n.resolveFileUrl ? n.resolveFileUrl(t.props.url).then((s3) => {
    a3.src = s3;
  }) : a3.src = t.props.url, a3.alt = t.props.name || t.props.caption || "BlockNote image", a3.contentEditable = "false", a3.draggable = false, r2.appendChild(a3), Pe(
    t,
    n,
    { dom: r2 },
    r2,
...
var rn = (e = {}) => (t, n) => {
  if (!t.props.url) {
    const r2 = document.createElement("p");
    return r2.textContent = "Add image", {
      dom: r2
    };
  }
  let o;
  return t.props.showPreview ? (o = document.createElement("img"), o.src = t.props.url, o.alt = t.props.name || t.props.caption || "BlockNote image", t.props.previewWidth && (o.width = t.props.previewWidth)) : (o = document.createElement("a"), o.href = t.props.url, o.textContent = t.props.name || t.props.url), t.props.caption ? t.props.showPreview ? J2(o, t.props.caption) : U(o, t.props.caption) : {
    dom: o
  };
};
var an = y(
...
var wo = (e, t, n) => ({
  state: o,
  dispatch: r2
}) => r2 ? Ne(o.tr, e, t, n) : true;
var Ne = (e, t, n, o) => {
  const r2 = Y(e.doc, t), a3 = Z(r2);
  if (!a3.isBlockContainer)
    return false;
  const s3 = ht(e), i = [
    {
      type: a3.bnBlock.node.type,
      // always keep blockcontainer type
      attrs: o ? { ...a3.bnBlock.node.attrs, id: void 0 } : {}
    },
    {
      type: n ? a3.blockContent.node.type : s3.nodes.paragraph,
      attrs: o ? { ...a3.blockContent.node.attrs } : {}
    }
  ];
  return e.split(t, 2, i), true;
};
var q = (e, t) => {
  const { blockInfo: n, selectionEmpty: o } = e.transact((s3) => ({
    blockInfo: Ot(s3),
    selectionEmpty: s3.selection.anchor === s3.selection.head
  }));
  if (!n.isBlockContainer)
    return false;
  const { bnBlock: r2, blockContent: a3 } = n;
  return a3.node.type.name !== t || !o ? false : a3.node.childCount === 0 ? (e.transact((s3) => {
    K3(s3, r2.beforePos, {
      type: "paragraph",
      props: {}
    });
  }), true) : a3.node.childCount > 0 ? e.transact((s3) => (s3.deleteSelection(), Ne(s3, s3.selection.from, true))) : false;
};
function Y2(e, t, n) {
  var d, p2, m;
  const o = DOMParser2.fromSchema(t), r2 = e, a3 = document.createElement("div");
  a3.setAttribute("data-node-type", "blockGroup");
  for (const f3 of Array.from(r2.childNodes))
    a3.appendChild(f3.cloneNode(true));
  let s3 = o.parse(a3, {
    topNode: t.nodes.blockGroup.create()
  });
  ((p2 = (d = s3.firstChild) == null ? void 0 : d.firstChild) == null ? void 0 : p2.type.name) === "checkListItem" && (s3 = s3.copy(
    s3.content.cut(
      s3.firstChild.firstChild.nodeSize + 2
    )
  ));
  const i = (m = s3.firstChild) == null ? void 0 : m.firstChild;
  if (!(i != null && i.isTextblock))
    return Fragment.from(s3);
...
var cn = y(
  sn,
  {
    ...
    parseContent: ({ el: e, schema: t }) => Y2(e, t, "bulletListItem"),
    render() {
    ...
    toExternalHTML(e) {
      ...
      return A2(e.props, t), t.appendChild(n), {
        dom: t,
        contentDOM: n
      };
    }
  ...
  ln,
  {
    ...
    parse(e) {
      ...
      if (t !== null && (t.tagName === "UL" || t.tagName === "DIV" && ((n = t.parentElement) == null ? void 0 : n.tagName) === "UL")) {
        ...
        return o === null ? void 0 : { ...v2(e), checked: o.checked };
      }
    },
    // As `li` elements can contain multiple paragraphs, we need to merge their contents
    // into a single one so that ProseMirror can parse everything correctly.
    parseContent: ({ el: e, schema: t }) => Y2(e, t, "checkListItem"),
    render(e, t) {
      ...
      const r2 = document.createElement("p"), a3 = document.createElement("div");
      return a3.contentEditable = "false", a3.appendChild(o), n.appendChild(a3), n.appendChild(r2), {
        dom: n,
        contentDOM: r2
      };
    },
    toExternalHTML(e) {
      ...
      const o = document.createElement("p");
      return A2(e.props, t), t.appendChild(n), t.appendChild(o), {
        dom: t,
        contentDOM: o
      };
    },
...
function He(e, t, n, o) {
  let r2 = e.firstChild.attrs.start || 1, a3 = true;
  const s3 = !!e.firstChild.attrs.start, i = Z({
    posBeforeNode: t,
    node: e
  });
  ...
  return l !== void 0 ? (r2 = l + 1, a3 = false) : c && Z({
    posBeforeNode: i.bnBlock.beforePos - c.nodeSize,
    node: c
  }).blockNoteType === "numberedListItem" && (r2 = He(
    c,
    i.bnBlock.beforePos - c.nodeSize,
    n,
    o
  ).index + 1, a3 = false), o.set(e, r2), { index: r2, isFirst: a3, hasStart: s3 };
}
function me(e, t) {
  ...
  e.doc.nodesBetween(0, e.doc.nodeSize - 2, (s3, i) => {
    if (s3.type.name === "blockContainer" && s3.firstChild.type.name === "numberedListItem") {
      ...
      if (o.find(
        i,
        i + s3.nodeSize,
        (p2) => p2.index === c && p2.isFirst === l && p2.hasStart === u
      ).length === 0) {
        const p2 = e.doc.nodeAt(i + 1);
        r2.push(
          // move in by 1 to account for the block container
          Decoration.node(i + 1, i + 1 + p2.nodeSize, {
  ...
  const a3 = r2.flatMap(
    (s3) => o.find(s3.from, s3.to)
  );
  return {
    decorations: o.remove(a3).add(e.doc, r2)
  };
}
var un = () => new Plugin({
  ...
  pn,
  {
    ...
    parse(e) {
      ...
      if (t !== null && (t.tagName === "OL" || t.tagName === "DIV" && ((n = t.parentElement) == null ? void 0 : n.tagName) === "OL")) {
        const o = parseInt(t.getAttribute("start") || "1"), r2 = v2(e);
        return e.previousElementSibling || o === 1 ? r2 : {
          ...r2,
          start: o
        };
      }
    ...
    // As `li` elements can contain multiple paragraphs, we need to merge their contents
    // into a single one so that ProseMirror can parse everything correctly.
    parseContent: ({ el: e, schema: t }) => Y2(e, t, "numberedListItem"),
    render() {
      const e = document.createElement("p");
      return {
        dom: e,
  ...
  Cn,
  {
    ...
    parse(e) {
      if (e.tagName === "BLOCKQUOTE") {
        const { backgroundColor: t, textColor: n } = v2(e);
...
var wn = Node3.create({
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    ...
    const n = gt2(
      ...
      ((a3 = this.options.domAttributes) == null ? void 0 : a3.inlineContent) || {}
    ...
    return (s3 = n.dom.firstChild) == null || s3.appendChild(o), n;
  },
  ...
  addNodeView() {
    return ({ node: e, HTMLAttributes: t }) => {
      ...
      class n extends TableView {
        constructor(a3, s3, i) {
          super(a3, s3), this.node = a3, this.cellMinWidth = s3, this.blockContentHTMLAttributes = i;
          const c = document.createElement("div");
          c.className = D2(
            "bn-block-content",
            i.class
          ), c.setAttribute("data-content-type", "table");
          for (const [p2, m] of Object.entries(
            i
          ))
            p2 !== "class" && c.setAttribute(p2, m);
        ...
        ignoreMutation(a3) {
          return !a3.target.closest(".tableWrapper-inner") || super.ignoreMutation(a3);
        }
      }
      return new n(e, Ie, {
...
function De(e, t) {
  ...
  return o.content.descendants((a3) => {
    if (a3.isInline)
      return r2.push(a3), false;
    ...
    a({
      ...
      keyboardShortcuts: {
        Backspace: ({ editor: e }) => {
          ...
          let o = 0;
          for (const a3 of n.rows)
            for (const s3 of a3.cells) {
              if ("type" in s3 && s3.content.length > 0 || !("type" in s3) && s3.length > 0)
                return false;
              o++;
            }
          let r2 = 0;
...
var Bn = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M2 3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44495 22 3.9934V20.0066C22 20.5552 21.5447 21 21.0082 21H2.9918C2.44405 21 2 20.5551 2 20.0066V3.9934ZM8 5V19H16V5H8ZM4 5V7H6V5H4ZM18 5V7H20V5H18ZM4 9V11H6V9H4ZM18 9V11H20V9H18ZM4 13V15H6V13H4ZM18 13V15H20V13H18ZM4 17V19H6V17H4ZM18 17V19H20V17H18Z"></path></svg>';
var An = (e) => ({
  type: "video",
  propSchema: {
    textAlignment: h.textAlignment,
...
var Nn = y(
  ...
  (e) => ({
    ...
    render(t, n) {
      ...
      const r2 = document.createElement("div");
      r2.className = "bn-visual-media-wrapper";
      const a3 = document.createElement("video");
      return a3.className = "bn-visual-media", n.resolveFileUrl ? n.resolveFileUrl(t.props.url).then((s3) => {
        a3.src = s3;
      }) : a3.src = t.props.url, a3.controls = true, a3.contentEditable = "false", a3.draggable = false, a3.width = t.props.previewWidth, r2.appendChild(a3), Pe(
        t,
        n,
        { dom: r2 },
        r2,
    ...
    toExternalHTML(t) {
      ...
      let n;
      return t.props.showPreview ? (n = document.createElement("video"), n.src = t.props.url, t.props.previewWidth && (n.width = t.props.previewWidth)) : (n = document.createElement("a"), n.href = t.props.url, n.textContent = t.props.name || t.props.url), t.props.caption ? t.props.showPreview ? J2(n, t.props.caption) : U(n, t.props.caption) : {
        dom: n
      };
    },
    runsBefore: ["file"]
...
function b(e, t, n) {
  ...
  if (!n)
    return true;
  for (const [o, r2] of Object.entries(n)) {
    if (!(o in e.schema.blockSpecs[t].config.propSchema))
      return false;
    if (typeof r2 == "string") {
      if (e.schema.blockSpecs[t].config.propSchema[o].default !== void 0 && typeof e.schema.blockSpecs[t].config.propSchema[o].default !== r2 || e.schema.blockSpecs[t].config.propSchema[o].type !== void 0 && e.schema.blockSpecs[t].config.propSchema[o].type !== r2)
        return false;
    } else {
      if (e.schema.blockSpecs[t].config.propSchema[o].default !== r2.default || e.schema.blockSpecs[t].config.propSchema[o].default === void 0 && r2.default === void 0 && e.schema.blockSpecs[t].config.propSchema[o].type !== r2.type || typeof e.schema.blockSpecs[t].config.propSchema[o].values != typeof r2.values)
        return false;
      if (typeof e.schema.blockSpecs[t].config.propSchema[o].values == "object" && typeof r2.values == "object") {
        for (const a3 of r2.values)
          if (!e.schema.blockSpecs[t].config.propSchema[o].values.includes(a3))
            return false;
      }
    }
  }
...
function In(e, t, n = "left") {
  const o = ySyncPluginKey.getState(e.prosemirrorState);
  if (!o) {
    const a3 = Hn(e), s3 = a3.maps.length;
    return () => a3.slice(s3).map(t, n === "left" ? -1 : 1);
  }
  ...
  return () => {
    const a3 = ySyncPluginKey.getState(
      e.prosemirrorState
    ), s3 = relativePositionToAbsolutePosition(
      a3.doc,
      a3.binding.type,
      r2,
      a3.binding.mapping
    ...
    return s3 + (n === "right" ? -1 : 1);
  };
}
var Dn = findParentNode((e) => e.type.name === "blockContainer");
var On = class {
  constructor(t, n, o) {
    M2(this, "state");
    M2(this, "emitUpdate");
    M2(this, "rootEl");
    M2(this, "pluginState");
    M2(this, "handleScroll", () => {
      var t2, n2;
      if ((t2 = this.state) != null && t2.show) {
        const o2 = (n2 = this.rootEl) == null ? void 0 : n2.querySelector(
          `[data-decoration-id="${this.pluginState.decorationId}"]`
        );
        if (!o2)
          return;
        this.state.referencePos = o2.getBoundingClientRect().toJSON(), this.emitUpdate(this.pluginState.triggerCharacter);
      }
    });
    M2(this, "closeMenu", () => {
      this.editor.transact((t2) => t2.setMeta(B2, null));
    });
    M2(this, "clearQuery", () => {
    ...
    var r2;
    this.editor = t, this.pluginState = void 0, this.emitUpdate = (a3) => {
      var s3;
      if (!this.state)
        throw new Error("Attempting to update uninitialized suggestions menu");
      n(a3, {
        ...this.state,
        ignoreQueryLength: (s3 = this.pluginState) == null ? void 0 : s3.ignoreQueryLength
      });
    }, this.rootEl = o.root, (r2 = this.rootEl) == null || r2.addEventListener("scroll", this.handleScroll, true);
  }
  update(t, n) {
    var l;
    const o = B2.getState(n), r2 = B2.getState(
      t.state
    ), a3 = o === void 0 && r2 !== void 0, s3 = o !== void 0 && r2 === void 0;
    if (!a3 && !(o !== void 0 && r2 !== void 0) && !s3)
      return;
    if (this.pluginState = s3 ? o : r2, s3 || !this.editor.isEditable) {
...
var B2 = new PluginKey("SuggestionMenuPlugin");
var _n = a(({ editor: e }) => {
  const t = [];
  let n;
  const o = f2(void 0);
  return {
    key: "suggestionMenu",
    store: o,
    addTriggerCharacter: (r2) => {
      t.push(r2);
    },
    removeTriggerCharacter: (r2) => {
      t.splice(t.indexOf(r2), 1);
    },
    closeMenu: () => {
      n == null || n.closeMenu();
    },
    ...
    shown: () => {
      var r2;
      return ((r2 = n == null ? void 0 : n.state) == null ? void 0 : r2.show) || false;
    },
    openSuggestionMenu: (r2, a3) => {
      e.headless || (e.focus(), e.transact((s3) => {
        a3 != null && a3.deleteTriggerCharacter && s3.insertText(r2), s3.scrollIntoView().setMeta(B2, {
          triggerCharacter: r2,
          deleteTriggerCharacter: (a3 == null ? void 0 : a3.deleteTriggerCharacter) || false,
          ignoreQueryLength: (a3 == null ? void 0 : a3.ignoreQueryLength) || false
        });
      }));
    },
    ...
    prosemirrorPlugins: [
      new Plugin({
        ...
        view: (r2) => (n = new On(
          e,
          (a3, s3) => {
            o.setState({ ...s3, triggerCharacter: a3 });
          },
          r2
        ), n),
        state: {
          ...
          apply: (r2, a3, s3, i) => {
            if (r2.selection.$from.parent.type.spec.code)
              return a3;
            const c = r2.getMeta(B2);
            if (typeof c == "object" && c !== null) {
              a3 && (n == null || n.closeMenu());
              const u = In(
                e,
            ...
            if (
              ...
              a3.triggerCharacter !== void 0 && i.selection.from < a3.queryStartPos() || // Moving the caret to a new block should hide the menu.
              !i.selection.$from.sameParent(
                i.doc.resolve(a3.queryStartPos())
              )
            )
              return;
            const l = { ...a3 };
        ...
        props: {
          handleTextInput(r2, a3, s3, i) {
            if (a3 === s3) {
              const c = r2.state.doc;
              for (const l of t) {
                const u = l.length > 1 ? c.textBetween(a3 - l.length, a3) + i : i;
                if (l === u)
                  return r2.dispatch(r2.state.tr.insertText(i)), r2.dispatch(
                    r2.state.tr.setMeta(B2, {
                      triggerCharacter: u
                    }).scrollIntoView()
                  ), true;
              }
          ...
          decorations(r2) {
            const a3 = this.getState(r2);
            if (a3 === void 0)
              return null;
            if (!a3.deleteTriggerCharacter) {
              const s3 = Dn(r2.selection);
              if (s3)
                return DecorationSet.create(r2.doc, [
                  Decoration.node(
                    s3.pos,
                    s3.pos + s3.node.nodeSize,
                    {
                      nodeName: "span",
                      class: "bn-suggestion-decorator",
                      "data-decoration-id": a3.decorationId
                    }
                  )
                ]);
            }
            return DecorationSet.create(r2.doc, [
              Decoration.inline(
                a3.queryStartPos() - a3.triggerCharacter.length,
                a3.queryStartPos(),
                {
                  nodeName: "span",
                  class: "bn-suggestion-decorator",
...
function C(e, t) {
  ...
  let o;
  return Array.isArray(n.content) && (n.content.length === 1 && B(n.content[0]) && n.content[0].type === "text" && n.content[0].text === "/" || n.content.length === 0) ? (o = e.updateBlock(n, t), e.setTextCursorPosition(o)) : (o = e.insertBlocks([t], n, "after")[0], e.setTextCursorPosition(e.getTextCursorPosition().nextBlock)), Vn(e), o;
}
function Bo(e) {
  const t = [];
  return b(e, "heading", { level: "number" }) && (e.schema.blockSchema.heading.propSchema.level.values || []).filter((n) => n <= 3).forEach((n) => {
    ...
    onItemClick: () => {
      ...
      (o = e.getExtension(I2)) == null || o.showMenu(n.id);
    },
    key: "image",
    ...
    t.push({
      onItemClick: () => {
        C(e, {
          type: "heading",
          props: { level: n, isToggleable: true }
        });
      },
...
function Ao(e, t) {
  return e.filter(
    ({ title: n, aliases: o }) => n.toLowerCase().includes(t.toLowerCase()) || o && o.filter(
      (r2) => r2.toLowerCase().includes(t.toLowerCase())
    ).length !== 0
  );
}
var Po = {
...
var Wn = Le(
  ...
  },
  {
    ...
    toExternalHTML: (e) => {
      ...
      return e !== h.textColor.default && (t.style.color = e in T2 ? T2[e].text : e), {
        dom: t,
        contentDOM: t
      };
    },
...
var Rn = Le(
  ...
  },
  {
    ...
    toExternalHTML: (e) => {
      const t = document.createElement("span");
      return e !== h.backgroundColor.default && (t.style.backgroundColor = e in T2 ? T2[e].background : e), {
        dom: t,
        contentDOM: t
      };
    },
...
var Fn = {
  bold: H2(index_default, "boolean"),
  italic: H2(index_default3, "boolean"),
  underline: H2(index_default5, "boolean"),
  strike: H2(index_default4, "boolean"),
  code: H2(index_default2, "boolean"),
  textColor: Wn,
  backgroundColor: Rn
};
var No = Mt2(Fn);
...
// node_modules/@blocknote/core/dist/TrailingNode-CxM966vN.js
...
function parseSelector(selector, defaultTagName) {
  ...
  while (start < value.length) {
    ...
    const subvalue = value.slice(start, match2 ? match2.index : value.length);
    if (subvalue) {
      if (!previous) {
        tagName = subvalue;
      } else if (previous === "#") {
...
function next(value, from3) {
  const cr = value.indexOf("\r", from3);
...
function element2(state, node) {
  ...
  const x2 = state.schema.space === "svg" ? s : h2;
...
function patch(state, from3, to) {
  if ("sourceCodeLocation" in from3 && from3.sourceCodeLocation && state.file) {
    const position3 = createLocation(state, to, from3.sourceCodeLocation);
    if (position3) {
      state.location = true;
...
function createLocation(state, node, location3) {
    ...
    if (state.verbose) {
      ...
      if (location3.attrs) {
        for (key in location3.attrs) {
          if (own.call(location3.attrs, key)) {
      ...
      const opening = position2(location3.startTag);
      const closing = location3.endTag ? position2(location3.endTag) : void 0;
      const data = { opening };
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/common/unicode.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/common/error-codes.js
var ERR;
(function(ERR2) {
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/tokenizer/preprocessor.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/common/token.js
var TokenType;
(function(TokenType2) {
...
// node_modules/hast-util-from-html/node_modules/entities/dist/esm/generated/decode-data-html.js
...
// node_modules/hast-util-from-html/node_modules/entities/dist/esm/generated/decode-data-xml.js
var xmlDecodeTree = new Uint16Array(
  // prettier-ignore
  "Ȁaglq	\x1Bɭ\0\0p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map((c) => c.charCodeAt(0))
);

// node_modules/hast-util-from-html/node_modules/entities/dist/esm/decode-codepoint.js
var _a;
...
// node_modules/hast-util-from-html/node_modules/entities/dist/esm/decode.js
var CharCodes;
(function(CharCodes2) {
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/common/html.js
var NS;
(function(NS2) {
...
var SPECIAL_ELEMENTS = {
  ...
  [NS.MATHML]: /* @__PURE__ */ new Set([$4.MI, $4.MO, $4.MN, $4.MS, $4.MTEXT, $4.ANNOTATION_XML]),
  [NS.SVG]: /* @__PURE__ */ new Set([$4.TITLE, $4.FOREIGN_OBJECT, $4.DESC]),
  [NS.XLINK]: /* @__PURE__ */ new Set(),
  [NS.XML]: /* @__PURE__ */ new Set(),
  [NS.XMLNS]: /* @__PURE__ */ new Set()
};
var NUMBERED_HEADERS = /* @__PURE__ */ new Set([$4.H1, $4.H2, $4.H3, $4.H4, $4.H5, $4.H6]);
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/tokenizer/index.js
var State;
(function(State2) {
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/parser/open-element-stack.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/parser/formatting-element-list.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/tree-adapters/default.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/common/doctype.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/common/foreign-content.js
var MIME_TYPES = {
  TEXT_HTML: "text/html",
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/parser/index.js
...
var Parser = class {
  ...
  /** @protected */
  _attachElementToTree(element4, location3) {
    if (this.options.sourceCodeLocationInfo) {
      const loc = location3 && {
        ...location3,
        startTag: location3
  ...
  _setEndLocation(element4, closingToken) {
    if (this.treeAdapter.getNodeSourceCodeLocation(element4) && closingToken.location) {
      ...
      const tn2 = this.treeAdapter.getTagName(element4);
      const endLoc = (
...
function genericEndTagInBody(p2, token) {
  ...
  for (let i = p2.openElements.stackTop; i > 0; i--) {
    ...
    const elementId = p2.openElements.tagIDs[i];
    if (tid === elementId && (tid !== TAG_ID.UNKNOWN || p2.treeAdapter.getTagName(element4) === tn2)) {
...
// node_modules/hast-util-from-html/node_modules/entities/dist/esm/escape.js
...
var getCodePoint = (
  ...
  String.prototype.codePointAt == null ? (c, index) => (c.charCodeAt(index) & 64512) === 55296 ? (c.charCodeAt(index) - 55296) * 1024 + c.charCodeAt(index + 1) - 56320 + 65536 : c.charCodeAt(index) : (
    ...
    (input2, index) => input2.codePointAt(index)
  )
);
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/serializer/index.js
...
// node_modules/hast-util-from-html/node_modules/parse5/dist/index.js
function parse4(html2, options) {
...
var embedded = convertElement(
   ...
   */
  function(element4) {
    return element4.tagName === "audio" || element4.tagName === "canvas" || element4.tagName === "embed" || element4.tagName === "iframe" || element4.tagName === "img" || element4.tagName === "math" || element4.tagName === "object" || element4.tagName === "picture" || element4.tagName === "svg" || element4.tagName === "video";
  }
);
...
function code(state, node) {
  ...
  if (classList) {
    ...
    while (++index < classList.length) {
      if (String(classList[index]).slice(0, prefix2.length) === prefix2) {
        lang = String(classList[index]).slice(prefix2.length);
        break;
      }
    }
  }
...
function dl(state, node) {
  ...
  if (content3.length > 0) {
    const result = {
      ...
      ordered: false,
      start: null,
      spread: listItemsSpread(content3),
      children: content3
    };
    state.patch(node, result);
    return result;
...
function handle(state, children) {
  ...
  const listItems = state.toSpecificContent(nodes, create7);
...
function findSelectedOptions(node, explicitProperties) {
  ...
  const max2 = Math.min(list3.length, size2);
  index = -1;
  while (++index < max2) {
    const option = list3[index];
    const properties2 = option.properties || {};
    const content3 = toText(option);
    const label = content3 || String(properties2.label || "");
    const value = String(properties2.value || "") || content3;
...
function input(state, node) {
  ...
  if (value) {
    ...
    const list3 = String(properties.list);
    const datalist = state.elementById.get(list3);
...
function hasProperty2(node, name) {
  const value = node.type === "element" && own2.call(node.properties, name) && node.properties[name];
...
function list2(state, node) {
  ...
  const children = state.toSpecificContent(state.all(node), create8);
  let start = null;
  if (ordered) {
...
function phrasing3(node) {
  ...
  return tagName ? phrasing2({ type: "element", tagName, properties: {}, children: [] }) : phrasing(node);
}
...
function tableRow(state, node) {
  const children = state.toSpecificContent(state.all(node), create9);
...
function one2(node, parent) {
  if (node.type === "element") {
    ...
    if (own3.call(this.handlers, node.tagName)) {
      return this.handlers[node.tagName](this, node, parent) || void 0;
    }
  } else if (own3.call(this.nodeHandlers, node.type)) {
...
function toMdast(tree, options) {
  ...
  visit(cleanTree, function(node) {
    if (node && node.type === "element" && node.properties) {
      const id2 = String(node.properties.id || "") || void 0;
      if (id2 && !state.elementById.has(id2)) {
        state.elementById.set(id2, node);
      }
    }
  });
...
function one3(node, options) {
  switch (node.nodeType) {
    case 1: {
      ...
      return element3(domNode, options);
    }
    // Ignore: Attr (2).
    case 3: {
      const domNode = (
...
function root2(node, options) {
  return { type: "root", children: all6(node, options) };
}
function doctype() {
  return { type: "doctype" };
}
...
function element3(node, options) {
  const space = node.namespaceURI;
  const x2 = space === webNamespaces.svg ? s : h2;
  ...
  return x2(tagName, properties, all6(content3, options));
}
function all6(node, options) {
...
var Be2 = (n, e, t) => e in n ? Ie2(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
var b2 = (n, e, t) => Be2(n, typeof e != "symbol" ? e + "" : e, t);
function ye(n) {
...
function be(n, e, t, o) {
  ...
  for (const c of r2)
    if (c.type.name !== "text" && n.schema.inlineContentSchema[c.type.name]) {
      ...
      if (l) {
        ...
        ), h3 = l.toExternalHTML ? l.toExternalHTML(
          u,
          n
        ) : l.render.call(
          {
        ...
        if (h3) {
          if (i.appendChild(h3.dom), h3.contentDOM) {
            const g = t.serializeFragment(
              c.content,
              o
            );
            h3.contentDOM.dataset.editable = "", h3.contentDOM.appendChild(g);
          }
          continue;
        }
      }
      ...
      for (const u of c.marks.toReversed())
        if (u.type.name in n.schema.styleSpecs) {
          const h3 = (n.schema.styleSpecs[u.type.name].implementation.toExternalHTML ?? n.schema.styleSpecs[u.type.name].implementation.render)(u.attrs.stringValue, n);
          h3.contentDOM.appendChild(l), l = h3.dom;
        } else {
          const h3 = u.type.spec.toDOM(u, true), g = DOMSerializer.renderSpec(document, h3);
  ...
  return i.childNodes.length === 1 && ((a3 = i.firstChild) == null ? void 0 : a3.nodeType) === 1 && ye(i.firstChild), i;
}
function bt3(n, e, t, o, r2, s3, i, a3) {
  var w, y2, C2, O2, _2, z, K4, Y3, X2;
  const c = (a3 == null ? void 0 : a3.document) ?? document, l = e.pmSchema.nodes.blockContainer, u = t.props || {};
  for (const [v6, x2] of Object.entries(
    e.schema.blockSchema[t.type].propSchema
  ))
    !(v6 in u) && x2.default !== void 0 && (u[v6] = x2.default);
  const h3 = (y2 = (w = l.spec) == null ? void 0 : w.toDOM) == null ? void 0 : y2.call(
    w,
    l.create({
      id: t.id,
      ...u
    })
  ), g = Array.from(h3.dom.attributes), m = e.blockImplementations[t.type].implementation, p2 = ((C2 = m.toExternalHTML) == null ? void 0 : C2.call(
    {},
    { ...t, props: u },
    e,
    {
  ...
  if (p2.dom.classList.contains("bn-block-content")) {
    const v6 = [
      ...g,
      ...Array.from(p2.dom.attributes)
    ].filter(
      (x2) => x2.name.startsWith("data") && x2.name !== "data-content-type" && x2.name !== "data-file-block" && x2.name !== "data-node-view-wrapper" && x2.name !== "data-node-type" && x2.name !== "data-id" && x2.name !== "data-editable"
    );
    for (const x2 of v6)
      p2.dom.firstChild.setAttribute(x2.name, x2.value);
    ye(p2.dom.firstChild), i > 0 && p2.dom.firstChild.setAttribute(
      "data-nesting-level",
      i.toString()
    ), d.append(...Array.from(p2.dom.childNodes));
  } else
    d.append(p2.dom), i > 0 && p2.dom.setAttribute(
      "data-nesting-level",
      i.toString()
    );
  if (p2.contentDOM && t.content) {
    const v6 = be(
      e,
      t.content,
      // TODO
    ...
    p2.contentDOM.appendChild(v6);
  }
  let f3;
  if (r2.has(t.type) ? f3 = "OL" : s3.has(t.type) && (f3 = "UL"), f3) {
    if (((O2 = n.lastChild) == null ? void 0 : O2.nodeName) !== f3) {
      const v6 = c.createElement(f3);
      f3 === "OL" && "start" in u && u.start && (u == null ? void 0 : u.start) !== 1 && v6.setAttribute("start", u.start + ""), n.append(v6);
    }
    n.lastChild.appendChild(d);
  } else
    n.append(d);
  if (t.children && t.children.length > 0) {
    const v6 = c.createDocumentFragment();
    if (ve(
      v6,
      e,
      t.children,
      ...
      i + 1,
      a3
    ), ((_2 = n.lastChild) == null ? void 0 : _2.nodeName) === "UL" || ((z = n.lastChild) == null ? void 0 : z.nodeName) === "OL")
      for (; ((K4 = v6.firstChild) == null ? void 0 : K4.nodeName) === "UL" || ((Y3 = v6.firstChild) == null ? void 0 : Y3.nodeName) === "OL"; )
        n.lastChild.lastChild.appendChild(v6.firstChild);
    e.pmSchema.nodes[t.type].isInGroup("blockContent") ? n.append(v6) : (X2 = p2.contentDOM) == null || X2.append(v6);
  }
}
var ve = (n, e, t, o, r2, s3, i = 0, a3) => {
  for (const c of t)
    bt3(
      n,
      e,
...
var vt2 = (n, e, t, o, r2, s3) => {
  const a3 = ((s3 == null ? void 0 : s3.document) ?? document).createDocumentFragment();
  return ve(
    a3,
    n,
    e,
...
var ke = (n, e) => {
  const t = DOMSerializer.fromSchema(n);
  return {
    exportBlocks: (o, r2) => {
      const s3 = vt2(
        e,
      ...
      return i.append(s3), i.innerHTML;
    },
    exportInlineContent: (o, r2) => {
      ...
      return i.append(s3.cloneNode(true)), i.innerHTML;
    }
  };
};
function kt3(n, e) {
...
function ee(n) {
  const e = "__root__", t = {}, o = {}, r2 = ht(n);
  return n.descendants((s3, i) => {
    if (!Bt(s3))
      return true;
    const a3 = kt3(n, i), c = a3 ?? e;
    o[c] || (o[c] = []);
    const l = L(s3, r2);
    return t[s3.attrs.id] = { block: l, parentId: a3 }, o[c].push(s3.attrs.id), true;
...
function St3(n, e) {
  ...
  if (!n || !e)
    return t;
  const o = new Set(n), r2 = e.filter((d) => o.has(d)), s3 = n.filter(
    (d) => r2.includes(d)
  );
  if (s3.length <= 1 || r2.length <= 1)
    return t;
  const i = {};
  for (let d = 0; d < s3.length; d++)
    i[s3[d]] = d;
  const a3 = r2.map((d) => i[d]), c = a3.length, l = [], u = [], h3 = new Array(c).fill(-1), g = (d, f3) => {
    let w = 0, y2 = d.length;
    for (; w < y2; ) {
      const C2 = w + y2 >>> 1;
      d[C2] < f3 ? w = C2 + 1 : y2 = C2;
    }
    return w;
  };
  for (let d = 0; d < c; d++) {
    const f3 = a3[d], w = g(l, f3);
    w > 0 && (h3[d] = u[w - 1]), w === l.length ? (l.push(f3), u.push(d)) : (l[w] = f3, u[w] = d);
  }
  const m = /* @__PURE__ */ new Set();
  let p2 = u[u.length - 1] ?? -1;
  for (; p2 !== -1; )
    m.add(p2), p2 = h3[p2];
...
function xt2(n, e = []) {
  const t = Ct3(n), o = combineTransactionSteps(n.before, [
    n,
    ...e
  ]), r2 = ee(
    o.before
    ...
    o.doc
  ), i = [], a3 = /* @__PURE__ */ new Set();
  Object.keys(s3.byId).filter((m) => !(m in r2.byId)).forEach((m) => {
    i.push({
      type: "insert",
      block: s3.byId[m].block,
      source: t,
      prevBlock: void 0
    }), a3.add(m);
  }), Object.keys(r2.byId).filter((m) => !(m in s3.byId)).forEach((m) => {
    i.push({
      type: "delete",
      block: r2.byId[m].block,
      source: t,
      prevBlock: void 0
    }), a3.add(m);
  }), Object.keys(s3.byId).filter((m) => m in r2.byId).forEach((m) => {
    var w, y2;
    const p2 = r2.byId[m], d = s3.byId[m];
    p2.parentId !== d.parentId ? (i.push({
      type: "move",
      block: d.block,
      prevBlock: p2.block,
      source: t,
      prevParent: p2.parentId ? (w = r2.byId[p2.parentId]) == null ? void 0 : w.block : void 0,
      currentParent: d.parentId ? (y2 = s3.byId[d.parentId]) == null ? void 0 : y2.block : void 0
    }), a3.add(m)) : (0, import_fast_deep_equal.default)(
      { ...p2.block, children: void 0 },
  ...
  const c = r2.childrenByParent, l = s3.childrenByParent, u = "__root__", h3 = /* @__PURE__ */ new Set([
    ...Object.keys(c),
    ...Object.keys(l)
  ]), g = /* @__PURE__ */ new Set();
  return h3.forEach((m) => {
    ...
    p2.size !== 0 && p2.forEach((d) => {
      var C2, O2;
      const f3 = r2.byId[d], w = s3.byId[d];
      !f3 || !w || f3.parentId !== w.parentId || a3.has(d) || (f3.parentId ?? u) !== m || g.has(d) || (g.add(d), i.push({
        type: "move",
        block: w.block,
        prevBlock: f3.block,
        source: t,
        prevParent: f3.parentId ? (C2 = r2.byId[f3.parentId]) == null ? void 0 : C2.block : void 0,
        currentParent: w.parentId ? (O2 = s3.byId[w.parentId]) == null ? void 0 : O2.block : void 0
      }), a3.add(d));
    });
  }), i;
}
  ...
  return {
    ...
    prosemirrorPlugins: [
      new Plugin({
        ...
        filterTransaction: (e) => {
          let t;
          return n.reduce((o, r2) => o === false ? o : r2({
            getChanges() {
              return t || (t = xt2(e), t);
            },
            tr: e
...
function te(n) {
  const e = n.charAt(0) === "#" ? n.substring(1, 7) : n, t = parseInt(e.substring(0, 2), 16), o = parseInt(e.substring(2, 4), 16), r2 = parseInt(e.substring(4, 6), 16), i = [t / 255, o / 255, r2 / 255].map((c) => c <= 0.03928 ? c / 12.92 : Math.pow((c + 0.055) / 1.055, 2.4));
  ...
  ({ options: n }) => {
    ...
    return t && ("setLocalStateField" in t && typeof t.setLocalStateField == "function" && t.setLocalStateField("user", n.user), "on" in t && typeof t.on == "function" && n.showCursorLabels !== "always" && t.on(
      ...
      ({
        ...
        for (const r2 of o) {
          const s3 = e.get(r2);
          s3 && (s3.element.setAttribute("data-active", ""), s3.hideTimeout && clearTimeout(s3.hideTimeout), e.set(r2, {
            element: s3.element,
            hideTimeout: setTimeout(() => {
              s3.element.removeAttribute("data-active");
            }, 2e3)
          }));
        }
      }
      ...
      prosemirrorPlugins: [
        t ? yCursorPlugin(t, {
          ...
          cursorBuilder(o, r2) {
            let s3 = e.get(r2);
            if (!s3) {
              const i = (n.renderCursor ?? Et2)(o);
              n.showCursorLabels !== "always" && (i.addEventListener("mouseenter", () => {
                const a3 = e.get(r2);
                a3.element.setAttribute("data-active", ""), a3.hideTimeout && (clearTimeout(a3.hideTimeout), e.set(r2, {
                  element: a3.element,
                  hideTimeout: void 0
                }));
                ...
                e.set(r2, {
                  element: a3.element,
                  hideTimeout: setTimeout(() => {
                    a3.element.removeAttribute("data-active");
                  }, 2e3)
                });
              })), s3 = {
                element: i,
...
var F2 = a(
  ({ options: n }) => ({
    key: "ySync",
    prosemirrorPlugins: [ySyncPlugin(n.fragment)],
    runsBefore: ["default"]
  })
);
var $5 = a(() => ({
...
function It3(n, e) {
  ...
  if (n._item === null) {
    ...
    const o = n._item, r2 = e.store.clients.get(o.id.client) ?? [], s3 = findIndexSS(r2, o.id.clock);
    return r2[s3].content.type;
  }
}
var go2 = a(
  ({ editor: n, options: e }) => {
    let t;
    const o = f2({ isForked: false });
    return {
      key: "yForkDoc",
      store: o,
      /**
      ...
      fork() {
        ...
        const s3 = new Doc();
        applyUpdate(s3, encodeStateAsUpdate(r2.doc));
        const i = It3(r2, s3);
        t = {
          undoStack: yUndoPluginKey.getState(n.prosemirrorState).undoManager.undoStack,
          originalFragment: r2,
          forkedFragment: i
       ...
       */
      merge({ keepChanges: r2 }) {
        if (!t)
          return;
        n.unregisterExtension(["ySync", "yCursor", "yUndo"]);
        const { originalFragment: s3, forkedFragment: i, undoStack: a3 } = t;
        if (n.registerExtension([
          ...
          n.prosemirrorState
        ).undoManager.undoStack = a3, r2) {
          const c = encodeStateAsUpdate(
            i.doc,
            encodeStateVector(s3.doc)
          );
          applyUpdate(s3.doc, c, n);
        }
        t = void 0, o.setState({ isForked: false });
      }
    };
  }
);
var Ce = (n, e) => {
  e(n), n.forEach((t) => {
    t instanceof YXmlElement && Ce(t, e);
  });
};
var Bt2 = (n, e) => {
  const t = /* @__PURE__ */ new Map();
  return n.forEach((o) => {
    o instanceof YXmlElement && Ce(o, (r2) => {
      if (r2.nodeName === "blockContainer" && r2.hasAttribute("id")) {
        const s3 = r2.getAttribute("textColor"), i = r2.getAttribute("backgroundColor"), a3 = {
          textColor: s3 === h.textColor.default ? void 0 : s3,
          backgroundColor: i === h.backgroundColor.default ? void 0 : i
        };
        (a3.textColor || a3.backgroundColor) && t.set(r2.getAttribute("id"), a3);
      }
    });
  }), t.size === 0 ? false : (e.doc.descendants((o, r2) => {
    if (o.type.name === "blockContainer" && t.has(o.attrs.id)) {
      const s3 = e.doc.nodeAt(r2 + 1);
      if (!s3)
        throw new Error("No element found");
      e.setNodeMarkup(r2 + 1, void 0, {
...
var wo2 = a(
  ({ options: n }) => {
    let e = false;
    const t = new PluginKey("schemaMigration");
    return {
      key: "schemaMigration",
      prosemirrorPlugins: [
        new Plugin({
          key: t,
          appendTransaction: (o, r2, s3) => {
            if (e || // If any of the transactions are not due to a yjs sync, we don't need to run the migration
            !o.some((a3) => a3.getMeta("y-sync$")) || // If none of the transactions result in a document change, we don't need to run the migration
            o.every((a3) => !a3.docChanged) || // If the fragment is still empty, we can't run the migration (since it has not yet been applied to the Y.Doc)
            !n.fragment.firstChild)
              return;
            const i = s3.tr;
            for (const a3 of Tt3)
              a3(n.fragment, i);
            if (e = true, !!i.docChanged)
              return i;
          }
        })
      ]
...
var bo2 = a(({ editor: n }) => {
  const e = f2(false), t = () => n.transact((o) => {
    var s3;
    if (o.selection.empty || o.selection instanceof NodeSelection && (o.selection.node.type.spec.content === "inline*" || ((s3 = o.selection.node.firstChild) == null ? void 0 : s3.type.spec.content) === "inline*") || o.selection instanceof TextSelection && o.doc.textBetween(o.selection.from, o.selection.to).length === 0)
      return false;
    let r2 = false;
    return o.selection.content().content.descendants((i) => (i.type.spec.code && (r2 = true), !r2)), !r2;
  });
  return {
    key: "formattingToolbar",
    store: e,
    mount({ dom: o, signal: r2 }) {
      let s3 = false;
      const i = n.onChange(() => {
        s3 || e.setState(t());
      }), a3 = n.onSelectionChange(() => {
        s3 || e.setState(t());
      });
      o.addEventListener(
        "pointerdown",
        () => {
          s3 = true, e.setState(false);
        },
        { signal: r2 }
      ), n.prosemirrorView.root.addEventListener(
        "pointerup",
        () => {
          s3 = false, n.isFocused() && e.setState(t());
        },
        { signal: r2, capture: true }
      ), o.addEventListener(
        "pointercancel",
        () => {
          s3 = false;
...
var ko2 = a(({ editor: n }) => {
  function e(r2) {
    let s3 = n.prosemirrorView.nodeDOM(r2);
    for (; s3 && s3.parentElement; ) {
      if (s3.nodeName === "A")
        return s3;
      s3 = s3.parentElement;
    }
  ...
  function t(r2, s3) {
    return n.transact((i) => {
      const a3 = i.doc.resolve(r2), c = a3.marks().find((u) => u.type.name === s3);
      if (!c)
        return;
      const l = getMarkRange(a3, c.type);
      if (l)
        return {
          range: l,
          mark: c,
  ...
  function o() {
    return n.transact((r2) => {
      const s3 = r2.selection;
      if (s3.empty)
        return t(s3.anchor, "link");
    });
  }
  return {
    key: "linkToolbar",
    ...
    getLinkAtElement(r2) {
      return n.transact(() => {
        const s3 = n.prosemirrorView.posAtDOM(r2, 0) + 1;
        return t(s3, "link");
      });
    },
    editLink(r2, s3, i = n.transact((a3) => a3.selection.anchor)) {
      n.transact((a3) => {
        const c = ht(a3), { range: l } = t(i + 1, "link") || {
          range: {
            from: a3.selection.from,
            to: a3.selection.to
          }
        };
        l && (a3.insertText(s3, l.from, l.to), a3.addMark(
          l.from,
          l.from + s3.length,
          c.mark("link", { href: r2 })
        ));
    ...
    deleteLink(r2 = n.transact((s3) => s3.selection.anchor)) {
      n.transact((s3) => {
        const i = ht(s3), { range: a3 } = t(r2 + 1, "link") || {
          range: {
            from: s3.selection.from,
            to: s3.selection.to
          }
        };
        a3 && s3.removeMark(a3.from, a3.to, i.marks.link).setMeta(
          "preventAutolink",
          true
        );
      }), n.prosemirrorView.focus();
...
var So2 = "https";
var Pt3 = new PluginKey("node-selection-keyboard");
var xo2 = a(
  () => ({
...
var Ot3 = new PluginKey("blocknote-placeholder");
var Eo2 = a(
  ({
    editor: n,
    options: e
    ...
    return {
      ...
      prosemirrorPlugins: [
        new Plugin({
          key: Ot3,
          view: (o) => {
            const r2 = `placeholder-selector-${v4_default()}`;
            o.dom.classList.add(r2);
            const s3 = document.createElement("style"), i = n._tiptapEditor.options.injectNonce;
            i && s3.setAttribute("nonce", i), o.root instanceof window.ShadowRoot ? o.root.append(s3) : o.root.head.appendChild(s3);
            const a3 = s3.sheet, c = (l = "") => `.${r2} .bn-block-content${l} .bn-inline-content:has(> .ProseMirror-trailingBreak:only-child):before`;
            try {
              const {
                default: l,
                emptyDocument: u,
              ...
              for (const [p2, d] of Object.entries(h3)) {
                const f3 = `[data-content-type="${p2}"]`;
                a3.insertRule(
                  `${c(f3)} { content: ${JSON.stringify(
                    d
                  )}; }`
                );
              }
            ...
            return {
              destroy: () => {
                o.root instanceof window.ShadowRoot ? o.root.removeChild(s3) : o.root.head.removeChild(s3);
              }
            };
          },
          props: {
            decorations: (o) => {
              const { doc: r2, selection: s3 } = o;
              if (!n.isEditable || !s3.empty || s3.$from.parent.type.spec.code)
                return;
              const i = [];
              ...
              const a3 = s3.$anchor, c = a3.parent;
              if (c.content.size === 0) {
                const l = a3.before();
                i.push(
...
var ne = new PluginKey("previous-blocks");
var Dt3 = {
  // Numbered List Items
  index: "index",
  // Headings
      ...
      new Plugin({
        ...
        view(e) {
          return {
            update: async (t, o) => {
              var r2;
              ((r2 = this.key) == null ? void 0 : r2.getState(t.state).updatedBlocks.size) > 0 && (n = setTimeout(() => {
                t.dispatch(
                  t.state.tr.setMeta(ne, { clearUpdate: true })
                );
              }, 0));
            },
            destroy: () => {
        ...
        state: {
          ...
          apply(e, t, o, r2) {
            if (t.currentTransactionOldBlockAttrs = {}, t.updatedBlocks.clear(), !e.docChanged || o.doc.eq(r2.doc))
              return t;
            const s3 = {}, i = findChildren(
              o.doc,
              (l) => l.attrs.id
            ), a3 = new Map(
            ...
            for (const l of c) {
              const u = a3.get(l.node.attrs.id), h3 = u == null ? void 0 : u.node.firstChild, g = l.node.firstChild;
              if (u && h3 && g) {
                const m = {
                  index: g.attrs.index,
                  level: g.attrs.level,
                  type: g.type.name,
                  depth: r2.doc.resolve(l.pos).depth
                }, p2 = {
                  index: h3.attrs.index,
                  level: h3.attrs.level,
                  type: h3.type.name,
                  depth: o.doc.resolve(u.pos).depth
                };
                s3[l.node.attrs.id] = p2, t.currentTransactionOldBlockAttrs[l.node.attrs.id] = p2, JSON.stringify(p2) !== JSON.stringify(m) && (p2["depth-change"] = p2.depth - m.depth, t.updatedBlocks.add(l.node.attrs.id));
              }
            }
            return t.prevTransactionOldBlockAttrs = s3, t;
          }
        },
        props: {
          decorations(e) {
            ...
            if (t.updatedBlocks.size === 0)
              return;
            const o = [];
            return e.doc.descendants((r2, s3) => {
              if (!r2.attrs.id || !t.updatedBlocks.has(r2.attrs.id))
                return;
              const i = t.currentTransactionOldBlockAttrs[r2.attrs.id], a3 = {};
              for (const [l, u] of Object.entries(i))
                a3["data-prev-" + Dt3[l]] = u || "none";
              const c = Decoration.node(s3, s3 + r2.nodeSize, {
                ...a3
              });
              o.push(c);
...
function At3() {
  const n = (e) => {
    ...
    for (let o = 0; o < t; o++) {
      const r2 = e.children[o];
      if (r2.type === "element" && (n(r2), r2.tagName === "u"))
        if (r2.children.length > 0) {
          e.children.splice(o, 1, ...r2.children);
          const s3 = r2.children.length - 1;
          t += s3, o += s3;
        } else
  ...
  const n = (e) => {
    ...
    if (e.children && "length" in e.children && e.children.length)
      for (let o = e.children.length - 1; o >= 0; o--) {
        const r2 = e.children[o], s3 = o + 1 < e.children.length ? e.children[o + 1] : void 0;
        r2.type === "element" && r2.tagName === "input" && ((t = r2.properties) == null ? void 0 : t.type) === "checkbox" && (s3 == null ? void 0 : s3.type) === "element" && s3.tagName === "p" ? (s3.tagName = "span", s3.children.splice(
          0,
          0,
...
function Nt2() {
  return (n) => {
    visit(n, "element", (e, t, o) => {
      var r2, s3, i, a3;
      if (o && e.tagName === "video") {
        const c = ((r2 = e.properties) == null ? void 0 : r2.src) || ((s3 = e.properties) == null ? void 0 : s3["data-url"]) || "", l = ((i = e.properties) == null ? void 0 : i.title) || ((a3 = e.properties) == null ? void 0 : a3["data-name"]) || "";
        o.children[t] = {
          type: "text",
          value: `![${l}](${c})`
        };
...
function xe(n) {
  return unified().use(rehypeParse, { fragment: true }).use(Nt2).use(At3).use(Mt3).use(rehypeRemark).use(remarkGfm).use(remarkStringify, {
    handlers: { text: (t) => t.value }
  }).processSync(n).value;
}
function Bo2(n, e, t, o) {
  const s3 = ke(e, t).exportBlocks(n, o);
  return xe(s3);
}
function Rt3(n) {
  const e = [];
  return n.descendants((t) => {
    var r2, s3;
    const o = ht(t);
    return t.type.name === "blockContainer" && ((r2 = t.firstChild) == null ? void 0 : r2.type.name) === "blockGroup" ? true : t.type.name === "columnList" && t.childCount === 1 ? ((s3 = t.firstChild) == null || s3.forEach((i) => {
      e.push(L(i, o));
    }), false) : t.type.isInGroup("bnBlock") ? (e.push(L(t, o)), false) : true;
  }), e;
}
var B3 = class _B extends Selection {
  constructor(t, o) {
    super(t, o);
    b2(this, "nodes");
    const r2 = t.node();
    this.nodes = [], t.doc.nodesBetween(t.pos, o.pos, (s3, i, a3) => {
      if (a3 !== null && a3.eq(r2))
        return this.nodes.push(s3), false;
    });
  }
  static create(t, o, r2 = o) {
    return new _B(t.resolve(o), t.resolve(r2));
  }
  content() {
    return new Slice(Fragment.from(this.nodes), 0, 0);
  }
  eq(t) {
    if (!(t instanceof _B) || this.nodes.length !== t.nodes.length || this.from !== t.from || this.to !== t.to)
      return false;
  ...
  map(t, o) {
    const r2 = o.mapResult(this.from), s3 = o.mapResult(this.to);
    return s3.deleted ? Selection.near(t.resolve(r2.pos)) : r2.deleted ? Selection.near(t.resolve(s3.pos)) : new _B(
      t.resolve(r2.pos),
      t.resolve(s3.pos)
    );
  }
...
Selection.jsonID("multiple-node", B3);
var E2;
function Lt2(n, e) {
  let t, o;
  const r2 = e.resolve(n.from).node().type.spec.group === "blockContent", s3 = e.resolve(n.to).node().type.spec.group === "blockContent", i = Math.min(n.$anchor.depth, n.$head.depth);
  if (r2 && s3) {
    const a3 = n.$from.start(i - 1), c = n.$to.end(i - 1);
    t = e.resolve(a3 - 1).pos, o = e.resolve(c + 1).pos;
  } else
    t = n.from, o = n.to;
  return { from: t, to: o };
}
function re(n, e, t = e) {
  ...
  const o = n.domAtPos(e).node.cloneNode(true), r2 = n.domAtPos(e).node, s3 = (h3, g) => Array.prototype.indexOf.call(h3.children, g), i = s3(
    r2,
  ...
  for (let h3 = r2.childElementCount - 1; h3 >= 0; h3--)
    (h3 > a3 || h3 < i) && o.removeChild(o.children[h3]);
  Ee(n.root), E2 = o;
  const c = E2.getElementsByTagName("iframe");
  for (let h3 = 0; h3 < c.length; h3++) {
    const g = c[h3], m = g.parentElement;
    m && m.removeChild(g);
  }
  const u = n.dom.className.split(" ").filter(
    (h3) => h3 !== "ProseMirror" && h3 !== "bn-root" && h3 !== "bn-editor"
  ).join(" ");
  E2.className = E2.className + " bn-drag-preview " + u, n.root instanceof ShadowRoot ? n.root.appendChild(E2) : n.root.body.appendChild(E2);
}
function Ee(n) {
  E2 !== void 0 && (n instanceof ShadowRoot ? n.removeChild(E2) : n.body.removeChild(E2), E2 = void 0);
}
function Vt2(n, e, t) {
  if (!n.dataTransfer || t.headless)
    return;
  const o = t.prosemirrorView, r2 = Tt2(e.id, o.state.doc);
  if (!r2)
    throw new Error(`Block with ID ${e.id} not found`);
  const s3 = r2.posBeforeNode;
  if (s3 != null) {
    const i = o.state.selection, a3 = o.state.doc, { from: c, to: l } = Lt2(i, a3), u = c <= s3 && s3 < l, h3 = i.$anchor.node() !== i.$head.node() || i instanceof B3;
    u && h3 ? (o.dispatch(
      o.state.tr.setSelection(B3.create(a3, c, l))
    ), re(o, c, l)) : (o.dispatch(
      o.state.tr.setSelection(NodeSelection.create(o.state.doc, s3))
    ), re(o, s3));
    const g = o.state.selection.content(), m = t.pmSchema, p2 = o.serializeForClipboard(g).dom.innerHTML, d = ke(m, t), f3 = Rt3(g.content), w = d.exportBlocks(f3, {}), y2 = xe(w);
    n.dataTransfer.clearData(), n.dataTransfer.setData("blocknote/html", p2), n.dataTransfer.setData("text/html", w), n.dataTransfer.setData("text/plain", y2), n.dataTransfer.effectAllowed = "move", n.dataTransfer.setDragImage(E2, 0, 0);
  }
}
var se = 250;
function U2(n, e, t = true) {
  const o = n.root.elementsFromPoint(e.left, e.top);
  for (const r2 of o)
    if (n.dom.contains(r2))
      return t && r2.closest("[data-node-type=columnList]") ? U2(
        n,
        {
...
function Ht3(n, e) {
  ...
  if (!r2)
    return;
  const s3 = r2.node.getBoundingClientRect();
  return U2(
    e,
    {
      left: s3.right - 10,
...
var Ft2 = class {
  constructor(e, t, o) {
    ...
    b2(this, "emitUpdate");
    b2(this, "mousePos");
    b2(this, "hoveredBlock");
    b2(this, "menuFrozen", false);
    b2(this, "isDragOrigin", false);
    b2(this, "updateState", (e2) => {
      this.state = e2, this.emitUpdate(this.state);
    });
    b2(this, "updateStateFromMousePos", () => {
      var o2, r2, s3, i, a3;
      if (this.menuFrozen || !this.mousePos)
        return;
      const e2 = this.findClosestEditorElement({
        clientX: this.mousePos.x,
        clientY: this.mousePos.y
      });
      if ((e2 == null ? void 0 : e2.element) !== this.pmView.dom || e2.distance > se) {
        (o2 = this.state) != null && o2.show && (this.state.show = false, this.updateState(this.state));
        return;
      }
      const t2 = Ht3(this.mousePos, this.pmView);
      if (!t2 || !this.editor.isEditable) {
        (r2 = this.state) != null && r2.show && (this.state.show = false, this.updateState(this.state));
        return;
      }
      if (!((s3 = this.state) != null && s3.show && ((i = this.hoveredBlock) != null && i.hasAttribute("data-id")) && ((a3 = this.hoveredBlock) == null ? void 0 : a3.getAttribute("data-id")) === t2.id) && (this.hoveredBlock = t2.node, this.editor.isEditable)) {
        const c = t2.node.getBoundingClientRect(), l = t2.node.closest("[data-node-type=column]");
        this.state = {
          show: true,
    ...
    b2(this, "onDragStart", (e2) => {
      var i;
      const t2 = (i = e2.dataTransfer) == null ? void 0 : i.getData("blocknote/html");
      if (!t2 || this.pmView.dragging)
        return;
      const o2 = document.createElement("div");
      o2.innerHTML = t2;
      const s3 = DOMParser2.fromSchema(this.pmView.state.schema).parse(o2, {
        topNode: this.pmView.state.schema.nodes.blockGroup.create()
      });
      this.pmView.dragging = {
        slice: new Slice(s3.content, 0, 0),
        move: true
      };
    });
    b2(this, "findClosestEditorElement", (e2) => {
      const t2 = Array.from(this.pmView.root.querySelectorAll(".bn-editor"));
      if (t2.length === 0)
        return null;
      let o2 = t2[0], r2 = Number.MAX_VALUE;
      return t2.forEach((s3) => {
        const i = s3.querySelector(".bn-block-group").getBoundingClientRect(), a3 = e2.clientX < i.left ? i.left - e2.clientX : e2.clientX > i.right ? e2.clientX - i.right : 0, c = e2.clientY < i.top ? i.top - e2.clientY : e2.clientY > i.bottom ? e2.clientY - i.bottom : 0, l = Math.sqrt(
          Math.pow(a3, 2) + Math.pow(c, 2)
        );
        l < r2 && (r2 = l, o2 = s3);
      }), {
        element: o2,
    ...
    b2(this, "onDragOver", (e2) => {
      if (e2.synthetic)
        return;
      const t2 = this.getDragEventContext(e2);
      if (!t2 || !t2.isDropPoint) {
        this.closeDropCursor();
        return;
      }
      t2.isDropPoint && !t2.isDropWithinEditorBounds && this.dispatchSyntheticEvent(e2);
    });
    b2(this, "closeDropCursor", () => {
      const e2 = new Event("dragleave", { bubbles: false });
      e2.synthetic = true, this.pmView.dom.dispatchEvent(e2);
    });
    b2(this, "getDragEventContext", (e2) => {
      var c;
      const t2 = !((c = e2.dataTransfer) != null && c.types.includes("blocknote/html")) && !!this.pmView.dragging, o2 = !!this.isDragOrigin, r2 = t2 || o2, s3 = this.findClosestEditorElement(e2);
      if (!s3 || s3.distance > se)
        return;
      const i = s3.element === this.pmView.dom, a3 = i && s3.distance === 0;
      if (!(!i && !r2))
        return {
          isDropPoint: i,
          isDropWithinEditorBounds: a3,
          isDragOrigin: r2
        };
    });
    b2(this, "onDrop", (e2) => {
      ...
      const { isDropPoint: o2, isDropWithinEditorBounds: r2, isDragOrigin: s3 } = t2;
      if (!r2 && o2 && this.dispatchSyntheticEvent(e2), o2) {
    ...
    b2(this, "onDragEnd", (e2) => {
      e2.synthetic || (this.pmView.dragging = null);
    });
    b2(this, "onKeyDown", (e2) => {
      var t2;
      (t2 = this.state) != null && t2.show && this.editor.isFocused() && (this.state.show = false, this.emitUpdate(this.state));
    });
    b2(this, "onMouseMove", (e2) => {
      var s3;
      if (this.menuFrozen)
        return;
      this.mousePos = { x: e2.clientX, y: e2.clientY };
      const t2 = this.pmView.dom.getBoundingClientRect(), o2 = this.mousePos.x > t2.left && this.mousePos.x < t2.right && this.mousePos.y > t2.top && this.mousePos.y < t2.bottom, r2 = this.pmView.dom.parentElement;
      if (
        // Cursor is within the editor area
        o2 && // An element is hovered
        e2 && e2.target && // Element is outside the editor
        !(r2 === e2.target || r2.contains(e2.target))
      ) {
        (s3 = this.state) != null && s3.show && (this.state.show = false, this.emitUpdate(this.state));
        return;
      }
  ...
  dispatchSyntheticEvent(e) {
    ...
    t.clientX = e.clientX, t.clientY = e.clientY, t.clientX = Math.min(
      ...
      o.top + o.height
    ), t.dataTransfer = e.dataTransfer, t.preventDefault = () => e.preventDefault(), t.synthetic = true, this.pmView.dom.dispatchEvent(t);
  }
  ...
  update(e, t) {
    var r2;
    !t.doc.eq(this.pmView.state.doc) && ((r2 = this.state) != null && r2.show) && this.updateStateFromMousePos();
  }
  destroy() {
    var e;
    (e = this.state) != null && e.show && (this.state.show = false, this.emitUpdate(this.state)), this.pmView.root.removeEventListener(
      "mousemove",
      this.onMouseMove,
      true
...
var $t3 = new PluginKey("SideMenuPlugin");
var To2 = a(({ editor: n }) => {
  let e;
  const t = f2(
    void 0
  ...
  return {
     ...
     */
    blockDragStart(o, r2) {
      e && (e.isDragOrigin = true), Vt2(o, r2, n);
    },
    /**
     * Handles drag & drop events for blocks.
     */
    blockDragEnd() {
      Ee(n.prosemirrorView.root), e && (e.isDragOrigin = false), n.blur();
    },
    /**
     ...
     */
    freezeMenu() {
      e.menuFrozen = true, e.state.show = true, e.emitUpdate(e.state);
    },
    /**
     ...
     */
    unfreezeMenu() {
      e.menuFrozen = false, e.state.show = false, e.emitUpdate(e.state);
    }
  };
});
var S2;
function ie(n) {
  S2 || (S2 = document.createElement("div"), S2.innerHTML = "_", S2.style.opacity = "0", S2.style.height = "1px", S2.style.width = "1px", n instanceof Document ? n.body.appendChild(S2) : n.appendChild(S2));
}
function Ut2(n) {
  S2 && (n instanceof Document ? n.body.removeChild(S2) : n.removeChild(S2), S2 = void 0);
}
function M3(n) {
...
var Kt2 = class {
  constructor(e, t, o) {
    ...
    b2(this, "tableId");
    b2(this, "tablePos");
    b2(this, "tableElement");
    b2(this, "menuFrozen", false);
    b2(this, "mouseState", "up");
    b2(this, "prevWasEditable", null);
    b2(this, "viewMousedownHandler", () => {
      this.mouseState = "down";
    });
    b2(this, "mouseUpHandler", (e2) => {
      this.mouseState = "up", this.mouseMoveHandler(e2);
    });
    b2(this, "mouseMoveHandler", (e2) => {
      var l, u, h3, g, m, p2, d, f3;
      if (this.menuFrozen || this.mouseState === "selecting" || !(e2.target instanceof Element) || !this.pmView.dom.contains(e2.target))
        return;
      const t2 = _t4(e2.target);
      if ((t2 == null ? void 0 : t2.type) === "cell" && this.mouseState === "down" && !((l = this.state) != null && l.draggingState)) {
        this.mouseState = "selecting", (u = this.state) != null && u.show && (this.state.show = false, this.state.showAddOrRemoveRowsButton = false, this.state.showAddOrRemoveColumnsButton = false, this.emitUpdate());
        return;
      }
      if (!t2 || !this.editor.isEditable) {
        (h3 = this.state) != null && h3.show && (this.state.show = false, this.state.showAddOrRemoveRowsButton = false, this.state.showAddOrRemoveColumnsButton = false, this.emitUpdate());
        return;
      }
      if (!t2.tbodyNode)
        return;
      const o2 = t2.tbodyNode.getBoundingClientRect(), r2 = Se(t2.domNode, this.pmView);
      if (!r2)
        return;
      ...
      if (b(this.editor, "table") && (this.tablePos = i.posBeforeNode + 1, s3 = a3), !s3)
        return;
      this.tableId = r2.id;
      const c = (g = t2.domNode.closest(".tableWrapper")) == null ? void 0 : g.querySelector(".table-widgets-container");
      if ((t2 == null ? void 0 : t2.type) === "wrapper") {
        const w = e2.clientY >= o2.bottom - 1 && // -1 to account for fractions of pixels in "bottom"
        e2.clientY < o2.bottom + 20, y2 = e2.clientX >= o2.right - 1 && e2.clientX < o2.right + 20, C2 = (
          // always hide handles when the actively hovered table changed
          ((m = this.state) == null ? void 0 : m.block.id) !== s3.id || // make sure we don't hide existing handles (keep col / row index) when
          // we're hovering just above or to the right of a table
          e2.clientX > o2.right || e2.clientY > o2.bottom
        );
        this.state = {
          ...this.state,
          show: true,
          showAddOrRemoveRowsButton: w,
          showAddOrRemoveColumnsButton: y2,
          referencePosTable: o2,
          block: s3,
          widgetContainer: c,
          colIndex: C2 || (p2 = this.state) == null ? void 0 : p2.colIndex,
          rowIndex: C2 || (d = this.state) == null ? void 0 : d.rowIndex,
          referencePosCell: C2 || (f3 = this.state) == null ? void 0 : f3.referencePosCell
        };
      } else {
        const w = M3(t2.domNode), y2 = M3(t2.domNode.parentElement), C2 = t2.domNode.getBoundingClientRect();
        if (this.state !== void 0 && this.state.show && this.tableId === r2.id && this.state.rowIndex === y2 && this.state.colIndex === w)
          return;
        this.state = {
          show: true,
          showAddOrRemoveColumnsButton: w === s3.content.rows[0].cells.length - 1,
          showAddOrRemoveRowsButton: y2 === s3.content.rows.length - 1,
          referencePosTable: o2,
          block: s3,
    ...
    b2(this, "dragOverHandler", (e2) => {
      var g;
      if (((g = this.state) == null ? void 0 : g.draggingState) === void 0)
        return;
      e2.preventDefault(), e2.dataTransfer.dropEffect = "move", zt2(
        ".prosemirror-dropcursor-block, .prosemirror-dropcursor-inline",
        this.pmView.root
      );
      const t2 = {
        left: Math.min(
          Math.max(e2.clientX, this.state.referencePosTable.left + 1),
          this.state.referencePosTable.right - 1
        ),
        top: Math.min(
          Math.max(e2.clientY, this.state.referencePosTable.top + 1),
          this.state.referencePosTable.bottom - 1
        )
      }, o2 = this.pmView.root.elementsFromPoint(t2.left, t2.top).filter(
      ...
      const r2 = o2[0];
      let s3 = false;
      const i = M3(r2.parentElement), a3 = M3(r2), c = this.state.draggingState.draggedCellOrientation === "row" ? this.state.rowIndex : this.state.colIndex, u = (this.state.draggingState.draggedCellOrientation === "row" ? i : a3) !== c;
      (this.state.rowIndex !== i || this.state.colIndex !== a3) && (this.state.rowIndex = i, this.state.colIndex = a3, this.state.referencePosCell = r2.getBoundingClientRect(), s3 = true);
      const h3 = this.state.draggingState.draggedCellOrientation === "row" ? t2.top : t2.left;
      this.state.draggingState.mousePos !== h3 && (this.state.draggingState.mousePos = h3, s3 = true), s3 && this.emitUpdate(), u && this.editor.transact((m) => m.setMeta(D3, true));
    });
    b2(this, "dropHandler", (e2) => {
      ...
      e2.preventDefault();
      const { draggingState: t2, colIndex: o2, rowIndex: r2 } = this.state, s3 = this.state.block.content.columnWidths;
      if (t2.draggedCellOrientation === "row") {
        if (!Jt(
          this.state.block,
          t2.originalIndex,
          r2
        ...
        const i = Mt(
          ...
          t2.originalIndex,
          o2
        ), [a3] = s3.splice(t2.originalIndex, 1);
        s3.splice(o2, 0, a3), this.editor.updateBlock(this.state.block, {
          type: "table",
          content: {
            ...this.state.block.content,
            columnWidths: s3,
...
var D3 = new PluginKey("TableHandlesPlugin");
var Po2 = a(({ editor: n }) => {
  let e;
  const t = f2(void 0);
  return {
    ...
    prosemirrorPlugins: [
      new Plugin({
        key: D3,
        view: (o) => (e = new Kt2(n, o, (r2) => {
          t.setState(
            r2.block ? {
              ...r2,
              draggingState: r2.draggingState ? { ...r2.draggingState } : void 0
            } : void 0
          );
        }), e),
        ...
        props: {
          decorations: (o) => {
            if (e === void 0 || e.state === void 0 || e.state.draggingState === void 0 || e.tablePos === void 0)
              return;
            const r2 = e.state.draggingState.draggedCellOrientation === "row" ? e.state.rowIndex : e.state.colIndex;
            if (r2 === void 0)
              return;
            const s3 = [], { block: i, draggingState: a3 } = e.state, { originalIndex: c, draggedCellOrientation: l } = a3;
            if (r2 === c || !i || l === "row" && !Jt(i, c, r2) || l === "col" && !_t(i, c, r2))
              return DecorationSet.create(o.doc, s3);
            const u = o.doc.resolve(e.tablePos + 1);
            return e.state.draggingState.draggedCellOrientation === "row" ? yt(
              e.state.block,
              r2
            ).forEach(({ row: g, col: m }) => {
              const p2 = o.doc.resolve(
                u.posAtIndex(g) + 1
              ), d = o.doc.resolve(
                p2.posAtIndex(m) + 1
              ), f3 = d.node(), w = d.pos + (r2 > c ? f3.nodeSize - 2 : 0);
              s3.push(
                // The widget is a small bar which spans the width of the cell.
                Decoration.widget(w, () => {
                  const y2 = document.createElement("div");
                  return y2.className = "bn-table-drop-cursor", y2.style.left = "0", y2.style.right = "0", r2 > c ? y2.style.bottom = "-2px" : y2.style.top = "-3px", y2.style.height = "4px", y2;
                })
              );
            }) : Ct(
              e.state.block,
              ...
              s3.push(
                ...
                Decoration.widget(w, () => {
                  const y2 = document.createElement("div");
                  return y2.className = "bn-table-drop-cursor", y2.style.top = "0", y2.style.bottom = "0", r2 > c ? y2.style.right = "-2px" : y2.style.left = "-3px", y2.style.width = "4px", y2;
                })
              );
            }), DecorationSet.create(o.doc, s3);
          }
        }
      })
    ],
    ...
    colDragStart(o) {
      ...
      ), !n.headless && (ie(n.prosemirrorView.root), o.dataTransfer.setDragImage(S2, 0, 0), o.dataTransfer.effectAllowed = "move");
    },
    /**
     * Callback that should be set on the `dragStart` event for whichever element
    ...
    rowDragStart(o) {
      ...
      ), !n.headless && (ie(n.prosemirrorView.root), o.dataTransfer.setDragImage(S2, 0, 0), o.dataTransfer.effectAllowed = "copyMove");
    },
    /**
    ...
    dragEnd() {
      ...
      e.state.draggingState = void 0, e.emitUpdate(), n.transact((o) => o.setMeta(D3, null)), !n.headless && Ut2(n.prosemirrorView.root);
    },
    /**
    ...
    getCellsAtRowHandle(o, r2) {
      return yt(o, r2);
    },
    /**
     * Get all the cells in a column of the table block.
     */
    getCellsAtColumnHandle(o, r2) {
      return Ct(o, r2);
    },
    /**
     ...
     */
    setCellSelection(o, r2, s3 = r2) {
      if (!e)
        throw new Error("Table handles view not initialized");
      const i = o.doc.resolve(e.tablePos + 1), a3 = o.doc.resolve(
        i.posAtIndex(r2.row) + 1
      ), c = o.doc.resolve(
        // No need for +1, since CellSelection expects the position before the cell
        a3.posAtIndex(r2.col)
      ), l = o.doc.resolve(
        i.posAtIndex(s3.row) + 1
      ), u = o.doc.resolve(
        // No need for +1, since CellSelection expects the position before the cell
        l.posAtIndex(s3.col)
      ), h3 = o.tr;
      return h3.setSelection(
        new CellSelection(c, u)
      ), o.apply(h3);
    },
    /**
    ...
    addRowOrColumn(o, r2) {
      n.exec((s3, i) => {
        const a3 = this.setCellSelection(
          s3,
          r2.orientation === "row" ? { row: o, col: 0 } : { row: 0, col: o }
        );
        return r2.orientation === "row" ? r2.side === "above" ? addRowBefore(a3, i) : addRowAfter(a3, i) : r2.side === "left" ? addColumnBefore(a3, i) : addColumnAfter(a3, i);
      });
    },
    /**
     * Removes a row or column from the table using prosemirror-table commands
     */
    removeRowOrColumn(o, r2) {
      return r2 === "row" ? n.exec((s3, i) => {
        const a3 = this.setCellSelection(s3, {
          row: o,
          col: 0
        });
        return deleteRow(a3, i);
      }) : n.exec((s3, i) => {
        const a3 = this.setCellSelection(s3, {
          row: 0,
          col: o
        });
        return deleteColumn(a3, i);
      });
    },
    /**
    ...
    splitCell(o) {
      return n.exec((r2, s3) => {
        const i = o ? this.setCellSelection(r2, o) : r2;
        return splitCell(i, s3);
      });
    },
    /**
    ...
    getCellSelection() {
      return n.transact((o) => {
        const r2 = o.selection;
        let s3 = r2.$from, i = r2.$to;
        if (To(r2)) {
          const { ranges: d } = r2;
          d.forEach((f3) => {
            s3 = f3.$from.min(s3 ?? f3.$from), i = f3.$to.max(i ?? f3.$to);
          });
        } else if (s3 = o.doc.resolve(
          r2.$from.pos - r2.$from.parentOffset - 1
        ), i = o.doc.resolve(
          r2.$to.pos - r2.$to.parentOffset - 1
        ), s3.pos === 0 || i.pos === 0)
          return;
        const a3 = o.doc.resolve(
          s3.pos - s3.parentOffset - 1
        ), c = o.doc.resolve(i.pos - i.parentOffset - 1), l = o.doc.resolve(a3.pos - a3.parentOffset - 1), u = s3.index(a3.depth), h3 = a3.index(l.depth), g = i.index(c.depth), m = c.index(l.depth), p2 = [];
        for (let d = h3; d <= m; d++)
          for (let f3 = u; f3 <= g; f3++)
            p2.push({ row: d, col: f3 });
        return {
          from: {
            row: h3,
            col: u
    ...
    getMergeDirection(o) {
      return n.transact((r2) => {
        const s3 = To(r2.selection) ? r2.selection : void 0;
        if (!s3 || !o || // Only offer the merge button if there is more than one cell selected.
        s3.ranges.length <= 1)
          return;
        const i = this.getCellSelection();
        if (i)
          return Ht(i.from, i.to, o) ? "vertical" : "horizontal";
      });
    },
    cropEmptyRowsOrColumns(o, r2) {
      return Rt(o, r2);
    },
    addRowsOrColumns(o, r2, s3) {
      return $t(o, r2, s3);
    }
  };
});
var ae = new PluginKey("trailingNode");
var Oo = a(() => ({
  key: "trailingNode",
  prosemirrorPlugins: [
    new Plugin({
      ...
      appendTransaction: (n, e, t) => {
        const { doc: o, tr: r2, schema: s3 } = t, i = ae.getState(t), a3 = o.content.size - 2, c = s3.nodes.blockContainer, l = s3.nodes.paragraph;
        if (i)
          return r2.insert(
            a3,
...
// node_modules/@blocknote/core/dist/ShowSelection-B0ch3unP.js
var s2 = new PluginKey("blocknote-show-selection");
var b3 = a(({ editor: a3 }) => {
  const e = f2(
    { enabledSet: /* @__PURE__ */ new Set() },
    {
      onUpdate() {
        a3.transact((t) => t.setMeta(s2, {}));
      }
    }
  );
  return {
      ...
      new Plugin({
        ...
        props: {
          decorations: (t) => {
            ...
            const i = Decoration.inline(n.from, n.to, {
              "data-show-selection": "true"
            });
            return DecorationSet.create(o, [i]);
          }
        }
      })
    ],
...
//# sourceMappingURL=chunk-EWRKQLPR.js.map
